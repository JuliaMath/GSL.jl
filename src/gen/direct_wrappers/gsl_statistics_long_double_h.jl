...
"""
function gsl_stats_long_double_mean(data, stride, n)
...
"""
function gsl_stats_long_double_variance(data, stride, n)
...
"""
function gsl_stats_long_double_sd(data, stride, n)
...
"""
function gsl_stats_long_double_variance_with_fixed_mean(data, stride, n, mean)
...
"""
function gsl_stats_long_double_sd_with_fixed_mean(data, stride, n, mean)
...
"""
function gsl_stats_long_double_tss(data, stride, n)
...
"""
function gsl_stats_long_double_tss_m(data, stride, n, mean)
...
"""
function gsl_stats_long_double_absdev(data, stride, n)
...
"""
function gsl_stats_long_double_skew(data, stride, n)
...
"""
function gsl_stats_long_double_kurtosis(data, stride, n)
...
"""
function gsl_stats_long_double_lag1_autocorrelation(data, stride, n)
...
"""
function gsl_stats_long_double_covariance(data1, stride1, data2, stride2, n)
...
"""
function gsl_stats_long_double_correlation(data1, stride1, data2, stride2, n)
...
"""
function gsl_stats_long_double_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_long_double_variance_m(data, stride, n, mean)
...
"""
function gsl_stats_long_double_sd_m(data, stride, n, mean)
...
"""
function gsl_stats_long_double_absdev_m(data, stride, n, mean)
...
"""
function gsl_stats_long_double_skew_m_sd(data, stride, n, mean, sd)
...
"""
function gsl_stats_long_double_kurtosis_m_sd(data, stride, n, mean, sd)
...
"""
function gsl_stats_long_double_lag1_autocorrelation_m(data, stride, n, mean)
...
"""
function gsl_stats_long_double_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
function gsl_stats_long_double_wmean(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wvariance(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wsd(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wvariance_with_fixed_mean(w, wstride, data, stride, n, mean)
...
"""
function gsl_stats_long_double_wsd_with_fixed_mean(w, wstride, data, stride, n, mean)
...
"""
function gsl_stats_long_double_wtss(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wtss_m(w, wstride, data, stride, n, wmean)
...
"""
function gsl_stats_long_double_wabsdev(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wskew(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wkurtosis(w, wstride, data, stride, n)
...
"""
function gsl_stats_long_double_wvariance_m(w, wstride, data, stride, n, wmean)
...
"""
function gsl_stats_long_double_wsd_m(w, wstride, data, stride, n, wmean)
...
"""
function gsl_stats_long_double_wabsdev_m(w, wstride, data, stride, n, wmean)
...
"""
function gsl_stats_long_double_wskew_m_sd(w, wstride, data, stride, n, wmean, wsd)
...
"""
function gsl_stats_long_double_wkurtosis_m_sd(w, wstride, data, stride, n, wmean, wsd)
...
"""
function gsl_stats_long_double_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_long_double_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_long_double_max(data, stride, n)
...
"""
function gsl_stats_long_double_min(data, stride, n)
...
"""
function gsl_stats_long_double_minmax(min, max, data, stride, n)
...
"""
function gsl_stats_long_double_max_index(data, stride, n)
...
"""
function gsl_stats_long_double_min_index(data, stride, n)
...
"""
function gsl_stats_long_double_minmax_index(min_index, max_index, data, stride, n)
...
"""
function gsl_stats_long_double_select(data, stride, n, k)
...
"""
function gsl_stats_long_double_median_from_sorted_data(sorted_data, stride, n)
...
"""
function gsl_stats_long_double_median(sorted_data, stride, n)
...
"""
function gsl_stats_long_double_quantile_from_sorted_data(sorted_data, stride, n, f)
...
"""
function gsl_stats_long_double_trmean_from_sorted_data(trim, sorted_data, stride, n)
...
"""
function gsl_stats_long_double_gastwirth_from_sorted_data(sorted_data, stride, n)
...
"""
function gsl_stats_long_double_mad0(data, stride, n, work)
...
"""
function gsl_stats_long_double_mad(data, stride, n, work)
...
"""
function gsl_stats_long_double_Sn0_from_sorted_data(sorted_data, stride, n, work)
...
"""
function gsl_stats_long_double_Sn_from_sorted_data(sorted_data, stride, n, work)
...
"""
function gsl_stats_long_double_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
"""
function gsl_stats_long_double_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
