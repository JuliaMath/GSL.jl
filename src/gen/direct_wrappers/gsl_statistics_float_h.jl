...
"""
function gsl_stats_float_covariance(data1, stride1, data2, stride2, n)
...
"""
    gsl_stats_float_correlation(data1, stride1, data2, stride2, n) -> Cdouble
...
"""
function gsl_stats_float_correlation(data1, stride1, data2, stride2, n)
...
"""
    gsl_stats_float_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_float_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_float_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
function gsl_stats_float_wvariance_with_fixed_mean(w, wstride, data, stride, n, mean)
...
"""
    gsl_stats_float_wsd_with_fixed_mean(w, wstride, data, stride, n, mean) -> Cdouble
...
"""
function gsl_stats_float_wsd_with_fixed_mean(w, wstride, data, stride, n, mean)
...
"""
function gsl_stats_float_wtss_m(w, wstride, data, stride, n, wmean)
...
"""
function gsl_stats_float_wvariance_m(w, wstride, data, stride, n, wmean)
...
"""
    gsl_stats_float_wsd_m(w, wstride, data, stride, n, wmean) -> Cdouble
...
"""
function gsl_stats_float_wsd_m(w, wstride, data, stride, n, wmean)
...
"""
    gsl_stats_float_wabsdev_m(w, wstride, data, stride, n, wmean) -> Cdouble
...
"""
function gsl_stats_float_wabsdev_m(w, wstride, data, stride, n, wmean)
...
"""
    gsl_stats_float_wskew_m_sd(w, wstride, data, stride, n, wmean, wsd) -> Cdouble
...
"""
function gsl_stats_float_wskew_m_sd(w, wstride, data, stride, n, wmean, wsd)
...
"""
    gsl_stats_float_wkurtosis_m_sd(w, wstride, data, stride, n, wmean, wsd) -> Cdouble
...
"""
function gsl_stats_float_wkurtosis_m_sd(w, wstride, data, stride, n, wmean, wsd)
...
"""
    gsl_stats_float_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_float_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
    gsl_stats_float_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_float_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_float_quantile_from_sorted_data(sorted_data, stride, n, f)
    ccall((:gsl_stats_float_quantile_from_sorted_data, libgsl), Cdouble, (Ref{Cfloat}, Csize_t, Csize_t, Cdouble), sorted_data, stride, n, f)
end

"""
    gsl_stats_float_trmean_from_sorted_data(trim, sorted_data, stride, n) -> Cdouble
...
"""
function gsl_stats_float_trmean_from_sorted_data(trim, sorted_data, stride, n)
...
"""
function gsl_stats_float_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
"""
    gsl_stats_float_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble
...
"""
function gsl_stats_float_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
