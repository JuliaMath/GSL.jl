...
function gsl_linalg_complex_LU_decomp (A::Ptr{Void}, p::Ptr{gsl_permutation}, signum::Ptr{Cint})
    ccall( (:gsl_linalg_complex_LU_decomp, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}, Ptr{Cint}), A, p, signum )
end
...
function gsl_linalg_complex_LU_solve (LU::Ptr{Void}, p::Ptr{gsl_permutation}, b::Ptr{Void}, x::Ptr{Void})
    ccall( (:gsl_linalg_complex_LU_solve, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}, Ptr{Void}, Ptr{Void}), LU, p, b, x )
end
...
function gsl_linalg_complex_LU_svx (LU::Ptr{Void}, p::Ptr{gsl_permutation}, x::Ptr{Void})
    ccall( (:gsl_linalg_complex_LU_svx, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}, Ptr{Void}), LU, p, x )
end
...
function gsl_linalg_complex_LU_refine (A::Ptr{Void}, LU::Ptr{Void}, p::Ptr{gsl_permutation}, b::Ptr{Void}, x::Ptr{Void}, residual::Ptr{Void})
    ccall( (:gsl_linalg_complex_LU_refine, "libgsl"), Cint, (Ptr{Void},
        Ptr{Void}, Ptr{gsl_permutation}, Ptr{Void}, Ptr{Void}, Ptr{Void}), A,
        LU, p, b, x, residual )
end
...
function gsl_linalg_complex_LU_invert (LU::Ptr{Void}, p::Ptr{gsl_permutation}, inverse::Ptr{Void})
    ccall( (:gsl_linalg_complex_LU_invert, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}, Ptr{Void}), LU, p, inverse )
end
...
#XXX Unknown input type LU::Ptr{gsl_matrix_complex}
#XXX Coerced type for LU::Ptr{Void}
function gsl_linalg_complex_LU_det (LU::Ptr{Void}, signum::Cint)
...
#XXX Unknown input type LU::Ptr{gsl_matrix_complex}
#XXX Coerced type for LU::Ptr{Void}
function gsl_linalg_complex_LU_sgndet (LU::Ptr{Void}, signum::Cint)
