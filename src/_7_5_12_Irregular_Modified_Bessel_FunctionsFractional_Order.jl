...
# 
#   Returns: Cint
function gsl_sf_bessel_Knu_e(nu::Cdouble, x::Cdouble)
...
# 
#   Returns: Cint
function gsl_sf_bessel_lnKnu_e(nu::Cdouble, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cint
function gsl_sf_bessel_Knu_scaled_e(nu::Cdouble, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
