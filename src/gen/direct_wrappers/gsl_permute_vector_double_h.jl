...
> This function applies the permutation p to the elements of the vector
> v, considered as a row-vector acted on by a permutation matrix from
> the right, $v' = v P$. The $j$-th column of the permutation matrix $P$
> is given by the $p_j$-th column of the identity matrix. The
...
> This function applies the inverse of the permutation p to the elements
> of the vector v, considered as a row-vector acted on by an inverse
> permutation matrix from the right, $v' = v P^T$. Note that for
