...
#XXX Unknown input type w::Ptr{gsl_eigen_symm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_symm (A::Ptr{gsl_matrix}, eval::Ptr{gsl_vector}, w::Ptr{Void})
...
#XXX Unknown input type w::Ptr{gsl_eigen_symmv_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_symmv (A::Ptr{gsl_matrix}, eval::Ptr{gsl_vector}, evec::Ptr{gsl_matrix}, w::Ptr{Void})
