...
function gsl_root_test_interval (x_lower::Cdouble, x_upper::Cdouble, epsabs::Cdouble, epsrel::Cdouble)
    ccall( (:gsl_root_test_interval, "libgsl"), Cint, (Cdouble, Cdouble,
        Cdouble, Cdouble), x_lower, x_upper, epsabs, epsrel )
end
...
function gsl_root_test_delta (x1::Cdouble, x0::Cdouble, epsabs::Cdouble, epsrel::Cdouble)
    ccall( (:gsl_root_test_delta, "libgsl"), Cint, (Cdouble, Cdouble,
        Cdouble, Cdouble), x1, x0, epsabs, epsrel )
end
...
function gsl_root_test_residual (f::Cdouble, epsabs::Cdouble)
    ccall( (:gsl_root_test_residual, "libgsl"), Cint, (Cdouble, Cdouble),
        f, epsabs )
end
