...
function gsl_multifit_fsolver_alloc (T::Ptr{Void}, n::Csize_t, p::Csize_t)
...
#XXX Coerced type for output Ptr{Void}
function gsl_multifit_fdfsolver_alloc (T::Ptr{Void}, n::Csize_t, p::Csize_t)
    ccall( (:gsl_multifit_fdfsolver_alloc, "libgsl"), Ptr{Void},
        (Ptr{Void}, Csize_t, Csize_t), T, n, p )
end
...
function gsl_multifit_fsolver_set (s::Ptr{Void}, f::Ptr{gsl_multifit_function}, x::Ptr{gsl_vector})
    ccall( (:gsl_multifit_fsolver_set, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_multifit_function}, Ptr{gsl_vector}), s, f, x )
end
...
function gsl_multifit_fdfsolver_set (s::Ptr{Void}, fdf::Ptr{gsl_multifit_function_fdf}, x::Ptr{gsl_vector})
    ccall( (:gsl_multifit_fdfsolver_set, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_multifit_function_fdf}, Ptr{gsl_vector}), s, fdf, x )
end
...
function gsl_multifit_fsolver_name (s::Ptr{Void})
    ccall( (:gsl_multifit_fsolver_name, "libgsl"), Ptr{Cchar}, (Ptr{Void},
        ), s )
end
