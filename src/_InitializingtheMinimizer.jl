...
function gsl_min_fminimizer_set (s::Ptr{Void}, f::Ptr{gsl_function}, x_minimum::Cdouble, x_lower::Cdouble, x_upper::Cdouble)
    ccall( (:gsl_min_fminimizer_set, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_function}, Cdouble, Cdouble, Cdouble), s, f, x_minimum,
        x_lower, x_upper )
end
...
#XXX Unknown input type s::Ptr{gsl_min_fminimizer}
#XXX Coerced type for s::Ptr{Void}
function gsl_min_fminimizer_set_with_values (s::Ptr{Void}, f::Ptr{gsl_function}, x_minimum::Cdouble, f_minimum::Cdouble, x_lower::Cdouble, f_lower::Cdouble, x_upper::Cdouble, f_upper::Cdouble)
    ccall( (:gsl_min_fminimizer_set_with_values, "libgsl"), Cint,
        (Ptr{Void}, Ptr{gsl_function}, Cdouble, Cdouble, Cdouble, Cdouble,
        Cdouble, Cdouble), s, f, x_minimum, f_minimum, x_lower, f_lower,
        x_upper, f_upper )
end
...
function gsl_min_fminimizer_name (s::Ptr{Void})
    ccall( (:gsl_min_fminimizer_name, "libgsl"), Ptr{Cchar}, (Ptr{Void}, ),
        s )
end
