...
# 
#   Returns: Cint
function gsl_sf_exp_err_e(x::Real, dx::Real)
...
@vectorize_2arg Number gsl_sf_exp_err_e
...
# 
#   Returns: Cint
function gsl_sf_exp_err_e10_e(x::Real, dx::Real)
...
@vectorize_2arg Number gsl_sf_exp_err_e10_e
...
# 
#   Returns: Cint
function gsl_sf_exp_mult_err_e(x::Real, dx::Real, y::Real, dy::Real)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
#@vectorize_4arg Number gsl_sf_exp_mult_err_e
...
# 
#   Returns: Cint
function gsl_sf_exp_mult_err_e10_e(x::Real, dx::Real, y::Real, dy::Real)
    result = convert(Ptr{gsl_sf_result_e10}, Array(gsl_sf_result_e10, 1))
...
#TODO This vectorization macro is not implemented
#@vectorize_4arg Number gsl_sf_exp_mult_err_e10_e
