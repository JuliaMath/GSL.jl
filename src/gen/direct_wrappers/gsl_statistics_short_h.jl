...
"""
function gsl_stats_short_covariance(data1, stride1, data2, stride2, n)
...
"""
    gsl_stats_short_correlation(data1, stride1, data2, stride2, n) -> Cdouble
...
"""
function gsl_stats_short_correlation(data1, stride1, data2, stride2, n)
...
"""
    gsl_stats_short_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_short_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_short_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
    gsl_stats_short_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_short_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
    gsl_stats_short_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_short_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_short_quantile_from_sorted_data(sorted_data, stride, n, f)
    ccall((:gsl_stats_short_quantile_from_sorted_data, libgsl), Cdouble, (Ref{Cshort}, Csize_t, Csize_t, Cdouble), sorted_data, stride, n, f)
end

"""
    gsl_stats_short_trmean_from_sorted_data(trim, sorted_data, stride, n) -> Cdouble
...
"""
function gsl_stats_short_trmean_from_sorted_data(trim, sorted_data, stride, n)
...
"""
function gsl_stats_short_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
"""
    gsl_stats_short_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble
...
"""
function gsl_stats_short_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
