...
"""
function gsl_matrix_complex_float_alloc_from_block(b, offset, n1, n2, d2)
...
@doc md"""
    gsl_matrix_complex_float_alloc_from_matrix(b, k1, k2, n1, n2) -> Ptr{gsl_matrix_complex_float}
...
"""
function gsl_matrix_complex_float_alloc_from_matrix(b, k1, k2, n1, n2)
...
@doc md"""
    gsl_vector_complex_float_alloc_row_from_matrix(m, i) -> Ptr{gsl_vector_complex_float}

C signature:
`gsl_vector_complex_float * gsl_vector_complex_float_alloc_row_from_matrix (gsl_matrix_complex_float * m, const size_t i)`
"""
function gsl_vector_complex_float_alloc_row_from_matrix(m, i)
...
@doc md"""
    gsl_vector_complex_float_alloc_col_from_matrix(m, j) -> Ptr{gsl_vector_complex_float}

C signature:
`gsl_vector_complex_float * gsl_vector_complex_float_alloc_col_from_matrix (gsl_matrix_complex_float * m, const size_t j)`
"""
function gsl_vector_complex_float_alloc_col_from_matrix(m, j)
...
@doc md"""
    gsl_matrix_complex_float_free(m) -> Cvoid

C signature:
`void gsl_matrix_complex_float_free (gsl_matrix_complex_float * m)`
"""
function gsl_matrix_complex_float_free(m)
    ccall((:gsl_matrix_complex_float_free, libgsl), Cvoid, (Ptr{gsl_matrix_complex_float},), m)
end

@doc md"""
    gsl_matrix_complex_float_submatrix(m, i, j, n1, n2) -> _gsl_matrix_complex_float_view
...
"""
function gsl_matrix_complex_float_submatrix(m, i, j, n1, n2)
...
@doc md"""
    gsl_matrix_complex_float_superdiagonal(m, k) -> _gsl_vector_complex_float_view

C signature:
`_gsl_vector_complex_float_view gsl_matrix_complex_float_superdiagonal (gsl_matrix_complex_float * m, const size_t k)`
"""
function gsl_matrix_complex_float_superdiagonal(m, k)
...
@doc md"""
    gsl_matrix_complex_float_subrow(m, i, offset, n) -> _gsl_vector_complex_float_view
...
"""
function gsl_matrix_complex_float_subrow(m, i, offset, n)
...
@doc md"""
    gsl_matrix_complex_float_subcolumn(m, j, offset, n) -> _gsl_vector_complex_float_view
...
"""
function gsl_matrix_complex_float_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_complex_float_view_array_with_tda(base, n1, n2, tda)
...
@doc md"""
    gsl_matrix_complex_float_view_vector(v, n1, n2) -> _gsl_matrix_complex_float_view
...
"""
function gsl_matrix_complex_float_view_vector(v, n1, n2)
...
@doc md"""
    gsl_matrix_complex_float_view_vector_with_tda(v, n1, n2, tda) -> _gsl_matrix_complex_float_view
...
"""
function gsl_matrix_complex_float_view_vector_with_tda(v, n1, n2, tda)
...
@doc md"""
    gsl_matrix_complex_float_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_submatrix(m, i, j, n1, n2)
...
@doc md"""
    gsl_matrix_complex_float_const_row(m, i) -> _gsl_vector_complex_float_const_view

C signature:
`_gsl_vector_complex_float_const_view gsl_matrix_complex_float_const_row (const gsl_matrix_complex_float * m, const size_t i)`
"""
function gsl_matrix_complex_float_const_row(m, i)
...
@doc md"""
    gsl_matrix_complex_float_const_column(m, j) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_column(m, j)
...
"""
function gsl_matrix_complex_float_const_subdiagonal(m, k)
...
@doc md"""
    gsl_matrix_complex_float_const_superdiagonal(m, k) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_superdiagonal(m, k)
...
@doc md"""
    gsl_matrix_complex_float_const_subrow(m, i, offset, n) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_subrow(m, i, offset, n)
...
@doc md"""
    gsl_matrix_complex_float_const_subcolumn(m, j, offset, n) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_subcolumn(m, j, offset, n)
...
@doc md"""
    gsl_matrix_complex_float_const_view_array(base, n1, n2) -> _gsl_matrix_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_view_array(base, n1, n2)
...
@doc md"""
    gsl_matrix_complex_float_const_view_array_with_tda(base, n1, n2, tda) -> _gsl_matrix_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_view_array_with_tda(base, n1, n2, tda)
...
@doc md"""
    gsl_matrix_complex_float_const_view_vector(v, n1, n2) -> _gsl_matrix_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_view_vector(v, n1, n2)
...
@doc md"""
    gsl_matrix_complex_float_const_view_vector_with_tda(v, n1, n2, tda) -> _gsl_matrix_complex_float_const_view
...
"""
function gsl_matrix_complex_float_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_complex_float_tricpy(uplo_src, copy_diag, dest, src)
...
@doc md"""
    gsl_matrix_complex_float_transpose_tricpy(uplo_src, copy_diag, dest, src) -> Cint
...
"""
function gsl_matrix_complex_float_transpose_tricpy(uplo_src, copy_diag, dest, src)
...
"""
function gsl_matrix_complex_float_const_ptr(m, i, j)
