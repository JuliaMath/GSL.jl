...
function gsl_odeiv2_driver_set_hmin (d::Ptr{Void}, hmin::Cdouble)
    ccall( (:gsl_odeiv2_driver_set_hmin, "libgsl"), Cint, (Ptr{Void},
        Cdouble), d, hmin )
end
...
function gsl_odeiv2_driver_set_hmax (d::Ptr{Void}, hmax::Cdouble)
    ccall( (:gsl_odeiv2_driver_set_hmax, "libgsl"), Cint, (Ptr{Void},
        Cdouble), d, hmax )
end
...
function gsl_odeiv2_driver_set_nmax (d::Ptr{Void}, nmax::Culong)
    ccall( (:gsl_odeiv2_driver_set_nmax, "libgsl"), Cint, (Ptr{Void},
        Culong), d, nmax )
end
...
#XXX Unknown input type d::Ptr{gsl_odeiv2_driver}
#XXX Coerced type for d::Ptr{Void}
function gsl_odeiv2_driver_apply (d::Ptr{Void}, t::Ptr{Cdouble}, t1::Cdouble, y::Cdouble)
    ccall( (:gsl_odeiv2_driver_apply, "libgsl"), Cint, (Ptr{Void},
        Ptr{Cdouble}, Cdouble, Cdouble), d, t, t1, y )
end
...
#XXX Unknown input type d::Ptr{gsl_odeiv2_driver}
#XXX Coerced type for d::Ptr{Void}
function gsl_odeiv2_driver_apply_fixed_step (d::Ptr{Void}, t::Ptr{Cdouble}, h::Cdouble, n::Culong, y::Cdouble)
    ccall( (:gsl_odeiv2_driver_apply_fixed_step, "libgsl"), Cint,
        (Ptr{Void}, Ptr{Cdouble}, Cdouble, Culong, Cdouble), d, t, h, n, y )
end
...
function gsl_odeiv2_driver_reset (d::Ptr{Void})
    ccall( (:gsl_odeiv2_driver_reset, "libgsl"), Cint, (Ptr{Void}, ), d )
end
...
function gsl_odeiv2_driver_free (d::Ptr{Void})
    ccall( (:gsl_odeiv2_driver_free, "libgsl"), Cint, (Ptr{Void}, ), d )
end
