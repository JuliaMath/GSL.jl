...
@doc md"""
    gsl_vector_char_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_char}
...
"""
function gsl_vector_char_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_char_const_subvector_with_stride(v, i, stride, n)
