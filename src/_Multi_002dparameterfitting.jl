...
### #XXX Unknown input type c::Ptr{gsl_vector}
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_linear (X::Ptr{gsl_matrix}, y::Ptr{gsl_vector}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
...
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_wlinear (X::Ptr{gsl_matrix}, w::Ptr{gsl_vector}, y::Ptr{gsl_vector}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
###     ccall( (:gsl_multifit_wlinear, "libgsl"), Cint, (Ptr{gsl_matrix},
###         Ptr{gsl_vector}, Ptr{gsl_vector}, Ptr{gsl_vector}, Ptr{gsl_matrix},
###         Ptr{Cdouble}, Ptr{gsl_multifit_linear_workspace}), X, w, y, c, cov,
###         chisq, work )
### end
...
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_linear_svd (X::Ptr{gsl_matrix}, y::Ptr{gsl_vector}, tol::Cdouble, rank::Ptr{Csize_t}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
...
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_wlinear_svd (X::Ptr{gsl_matrix}, w::Ptr{gsl_vector}, y::Ptr{gsl_vector}, tol::Cdouble, rank::Ptr{Csize_t}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
...
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_linear_usvd (X::Ptr{gsl_matrix}, y::Ptr{gsl_vector}, tol::Cdouble, rank::Ptr{Csize_t}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
...
### #XXX Unknown input type cov::Ptr{gsl_matrix}
### #XXX Unknown input type work::Ptr{gsl_multifit_linear_workspace}
### function gsl_multifit_wlinear_usvd (X::Ptr{gsl_matrix}, w::Ptr{gsl_vector}, y::Ptr{gsl_vector}, tol::Cdouble, rank::Ptr{Csize_t}, c::Ptr{gsl_vector}, cov::Ptr{gsl_matrix}, chisq::Ptr{Cdouble}, work::Ptr{gsl_multifit_linear_workspace})
...
### #XXX Unknown input type y::Ptr{gsl_vector}
### #XXX Unknown input type c::Ptr{gsl_vector}
### #XXX Unknown input type r::Ptr{gsl_vector}
