...
"""
function gsl_vector_complex_alloc(n)
...
"""
function gsl_vector_complex_calloc(n)
...
"""
function gsl_vector_complex_alloc_from_block(b, offset, n, stride)
...
"""
function gsl_vector_complex_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_complex_free(v)
...
"""
function gsl_vector_complex_view_array(base, n)
...
"""
function gsl_vector_complex_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_complex_const_view_array(base, n)
...
"""
function gsl_vector_complex_const_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_complex_subvector(base, i, n)
...
"""
function gsl_vector_complex_subvector_with_stride(v, i, stride, n)
...
"""
function gsl_vector_complex_const_subvector(base, i, n)
...
"""
function gsl_vector_complex_const_subvector_with_stride(v, i, stride, n)
...
"""
function gsl_vector_complex_const_real(v)
...
"""
function gsl_vector_complex_const_imag(v)
...
"""
function gsl_vector_complex_set_zero(v)
...
"""
function gsl_vector_complex_set_all(v, z)
...
"""
function gsl_vector_complex_set_basis(v, i)
...
"""
function gsl_vector_complex_fread(stream, v)
...
"""
function gsl_vector_complex_fwrite(stream, v)
...
"""
function gsl_vector_complex_fscanf(stream, v)
...
"""
function gsl_vector_complex_fprintf(stream, v, format)
...
"""
function gsl_vector_complex_memcpy(dest, src)
...
"""
function gsl_vector_complex_reverse(v)
...
"""
function gsl_vector_complex_swap(v, w)
...
"""
function gsl_vector_complex_swap_elements(v, i, j)
...
"""
function gsl_vector_complex_equal(u, v)
...
"""
function gsl_vector_complex_isnull(v)
...
"""
function gsl_vector_complex_ispos(v)
...
"""
function gsl_vector_complex_isneg(v)
...
"""
function gsl_vector_complex_isnonneg(v)
...
"""
function gsl_vector_complex_add(a, b)
...
"""
function gsl_vector_complex_sub(a, b)
...
"""
function gsl_vector_complex_mul(a, b)
...
"""
function gsl_vector_complex_div(a, b)
...
"""
function gsl_vector_complex_scale(a, x)
...
"""
function gsl_vector_complex_add_constant(a, x)
...
"""
function gsl_vector_complex_get(v, i)
...
"""
function gsl_vector_complex_set(v, i, z)
...
"""
function gsl_vector_complex_ptr(v, i)
...
"""
function gsl_vector_complex_const_ptr(v, i)
