...
"""
function gsl_vector_complex_long_double_alloc_from_block(b, offset, n, stride)
...
"""
    gsl_vector_complex_long_double_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_complex_long_double}
...
"""
function gsl_vector_complex_long_double_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_complex_long_double_view_array_with_stride(base, stride, n)
...
"""
    gsl_vector_complex_long_double_const_view_array(base, n) -> _gsl_vector_complex_long_double_const_view
...
"""
function gsl_vector_complex_long_double_const_view_array(base, n)
...
"""
    gsl_vector_complex_long_double_const_view_array_with_stride(base, stride, n) -> _gsl_vector_complex_long_double_const_view
...
"""
function gsl_vector_complex_long_double_const_view_array_with_stride(base, stride, n)
...
"""
    gsl_vector_complex_long_double_subvector(base, i, n) -> _gsl_vector_complex_long_double_view
...
"""
function gsl_vector_complex_long_double_subvector(base, i, n)
...
"""
    gsl_vector_complex_long_double_subvector_with_stride(v, i, stride, n) -> _gsl_vector_complex_long_double_view
...
"""
function gsl_vector_complex_long_double_subvector_with_stride(v, i, stride, n)
...
"""
    gsl_vector_complex_long_double_const_subvector(base, i, n) -> _gsl_vector_complex_long_double_const_view
...
"""
function gsl_vector_complex_long_double_const_subvector(base, i, n)
...
"""
    gsl_vector_complex_long_double_const_subvector_with_stride(v, i, stride, n) -> _gsl_vector_complex_long_double_const_view
...
"""
function gsl_vector_complex_long_double_const_subvector_with_stride(v, i, stride, n)
...
"""
    gsl_vector_complex_long_double_const_imag(v) -> _gsl_vector_long_double_const_view

C signature:
`_gsl_vector_long_double_const_view gsl_vector_complex_long_double_const_imag (const gsl_vector_complex_long_double *v)`
"""
function gsl_vector_complex_long_double_const_imag(v)
...
"""
    gsl_vector_complex_long_double_ptr(v, i) -> Ptr{gsl_complex_long_double}

C signature:
`gsl_complex_long_double *gsl_vector_complex_long_double_ptr (gsl_vector_complex_long_double * v, const size_t i)`
"""
function gsl_vector_complex_long_double_ptr(v, i)
...
"""
    gsl_vector_complex_long_double_const_ptr(v, i) -> Ptr{gsl_complex_long_double}
...
"""
function gsl_vector_complex_long_double_const_ptr(v, i)
