...
"""
function gsl_odeiv_step_alloc(T, dim)
...
"""
function gsl_odeiv_step_reset(s)
...
"""
function gsl_odeiv_step_free(s)
...
"""
function gsl_odeiv_step_name(s)
...
"""
function gsl_odeiv_step_order(s)
...
"""
function gsl_odeiv_step_apply(s, t, h, y, yerr, dydt_in, dydt_out, dydt)
...
"""
function gsl_odeiv_control_alloc(T)
...
"""
function gsl_odeiv_control_init(c, eps_abs, eps_rel, a_y, a_dydt)
...
"""
function gsl_odeiv_control_free(c)
...
"""
function gsl_odeiv_control_hadjust(c, s, y, yerr, dydt, h)
...
"""
function gsl_odeiv_control_name(c)
...
"""
function gsl_odeiv_control_standard_new(eps_abs, eps_rel, a_y, a_dydt)
...
"""
function gsl_odeiv_control_y_new(eps_abs, eps_rel)
...
"""
function gsl_odeiv_control_yp_new(eps_abs, eps_rel)
...
"""
function gsl_odeiv_control_scaled_new(eps_abs, eps_rel, a_y, a_dydt, scale_abs, dim)
...
"""
function gsl_odeiv_evolve_alloc(dim)
...
"""
function gsl_odeiv_evolve_apply(e, con, step, dydt, t, t1, h, y)
...
"""
function gsl_odeiv_evolve_reset(e)
...
"""
function gsl_odeiv_evolve_free(e)
