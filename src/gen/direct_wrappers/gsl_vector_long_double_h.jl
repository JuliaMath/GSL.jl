...
"""
function gsl_vector_long_double_alloc_from_block(b, offset, n, stride)
...
@doc md"""
    gsl_vector_long_double_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_long_double}
...
"""
function gsl_vector_long_double_alloc_from_vector(v, offset, n, stride)
...
@doc md"""
    gsl_vector_long_double_const_view_array(v, n) -> _gsl_vector_long_double_const_view

C signature:
`_gsl_vector_long_double_const_view gsl_vector_long_double_const_view_array (const long double *v, size_t n)`
"""
function gsl_vector_long_double_const_view_array(v, n)
    ccall((:gsl_vector_long_double_const_view_array, libgsl), _gsl_vector_long_double_const_view, (Ref{Cdouble}, Csize_t), v, n)
end

@doc md"""
    gsl_vector_long_double_const_view_array_with_stride(base, stride, n) -> _gsl_vector_long_double_const_view
...
"""
function gsl_vector_long_double_const_view_array_with_stride(base, stride, n)
...
@doc md"""
    gsl_vector_long_double_subvector(v, i, n) -> _gsl_vector_long_double_view

C signature:
`_gsl_vector_long_double_view gsl_vector_long_double_subvector (gsl_vector_long_double *v, size_t i, size_t n)`
"""
function gsl_vector_long_double_subvector(v, i, n)
...
@doc md"""
    gsl_vector_long_double_subvector_with_stride(v, i, stride, n) -> _gsl_vector_long_double_view
...
"""
function gsl_vector_long_double_subvector_with_stride(v, i, stride, n)
...
@doc md"""
    gsl_vector_long_double_const_subvector(v, i, n) -> _gsl_vector_long_double_const_view
...
"""
function gsl_vector_long_double_const_subvector(v, i, n)
...
@doc md"""
    gsl_vector_long_double_const_subvector_with_stride(v, i, stride, n) -> _gsl_vector_long_double_const_view
...
"""
function gsl_vector_long_double_const_subvector_with_stride(v, i, stride, n)
