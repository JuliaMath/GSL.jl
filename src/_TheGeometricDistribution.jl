...
function gsl_ran_geometric_pdf (k::Cuint, p::Cdouble)
    ccall( (:gsl_ran_geometric_pdf, "libgsl"), Cdouble, (Cuint, Cdouble),
        k, p )
end
...
function gsl_cdf_geometric_P (k::Cuint, p::Cdouble)
    ccall( (:gsl_cdf_geometric_P, "libgsl"), Cdouble, (Cuint, Cdouble), k,
        p )
end
...
function gsl_cdf_geometric_Q (k::Cuint, p::Cdouble)
    ccall( (:gsl_cdf_geometric_Q, "libgsl"), Cdouble, (Cuint, Cdouble), k,
        p )
end
