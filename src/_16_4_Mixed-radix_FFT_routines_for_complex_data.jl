...
##################################################
export gsl_fft_complex_wavetable, fft_complex_wavetable_alloc,
       fft_complex_wavetable_free, fft_complex_workspace_alloc,
       fft_complex_workspace_free, fft_complex_forward, fft_complex_transform,
       fft_complex_backward, fft_complex_inverse, fft_complex_inverse
...
function fft_complex_wavetable_alloc(n::Integer)
    ccall( (:gsl_fft_complex_wavetable_alloc, :libgsl),
        Ptr{gsl_fft_complex_wavetable}, (Csize_t, ), n )
end
@vectorize_1arg Number fft_complex_wavetable_alloc
...
# 
#   Returns: Void
function fft_complex_wavetable_free(wavetable::Ptr{gsl_fft_complex_wavetable})
...
function fft_complex_workspace_alloc(n::Integer)
    ccall( (:gsl_fft_complex_workspace_alloc, :libgsl),
        Ptr{gsl_fft_complex_workspace}, (Csize_t, ), n )
end
@vectorize_1arg Number fft_complex_workspace_alloc
...
# 
#   Returns: Void
function fft_complex_workspace_free(workspace::Ptr{gsl_fft_complex_workspace})
...
# 
#   Returns: Cint
function fft_complex_forward(data::gsl_complex_packed_array, stride::Integer, n::Integer, wavetable::Ptr{gsl_fft_complex_wavetable})
    work = convert(Ptr{gsl_fft_complex_workspace}, Array(gsl_fft_complex_workspace, 1))
    errno = ccall( (:gsl_fft_complex_forward, :libgsl), Cint,
...
# 
#   Returns: Cint
function fft_complex_transform(data::gsl_complex_packed_array, stride::Integer, n::Integer, wavetable::Ptr{gsl_fft_complex_wavetable}, sign::gsl_fft_direction)
    work = convert(Ptr{gsl_fft_complex_workspace}, Array(gsl_fft_complex_workspace, 1))
    errno = ccall( (:gsl_fft_complex_transform, :libgsl), Cint,
        (gsl_complex_packed_array, Csize_t, Csize_t,
...
# 
#   Returns: Cint
function fft_complex_backward(data::gsl_complex_packed_array, stride::Integer, n::Integer, wavetable::Ptr{gsl_fft_complex_wavetable})
    work = convert(Ptr{gsl_fft_complex_workspace}, Array(gsl_fft_complex_workspace, 1))
    errno = ccall( (:gsl_fft_complex_backward, :libgsl), Cint,
        (gsl_complex_packed_array, Csize_t, Csize_t,
        Ptr{gsl_fft_complex_wavetable}, Ptr{gsl_fft_complex_workspace}), data,
        stride, n, wavetable, work )
    if errno!= 0 throw(GSL_ERROR(errno)) end
...
# 
#   Returns: Cint
function fft_complex_inverse(data::gsl_complex_packed_array, stride::Integer, n::Integer, wavetable::Ptr{gsl_fft_complex_wavetable})
    work = convert(Ptr{gsl_fft_complex_workspace}, Array(gsl_fft_complex_workspace, 1))
    errno = ccall( (:gsl_fft_complex_inverse, :libgsl), Cint,
        (gsl_complex_packed_array, Csize_t, Csize_t,
        Ptr{gsl_fft_complex_wavetable}, Ptr{gsl_fft_complex_workspace}), data,
        stride, n, wavetable, work )
    if errno!= 0 throw(GSL_ERROR(errno)) end
