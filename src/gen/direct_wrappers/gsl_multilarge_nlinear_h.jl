...
"""
    gsl_multilarge_nlinear_alloc(T, params, n, p) -> Ptr{gsl_multilarge_nlinear_workspace}
...
"""
function gsl_multilarge_nlinear_alloc(T, params, n, p)
...
"""
    gsl_multilarge_nlinear_winit(x, wts, fdf, w) -> Cint
...
"""
function gsl_multilarge_nlinear_winit(x, wts, fdf, w)
...
"""
    gsl_multilarge_nlinear_eval_df(TransJ, x, f, u, swts, h, fdtype, fdf, v, JTJ, work) -> Cint
...
"""
function gsl_multilarge_nlinear_eval_df(TransJ, x, f, u, swts, h, fdtype, fdf, v, JTJ, work)
...
"""
    gsl_multilarge_nlinear_eval_fvv(h, x, v, f, swts, fdf, yvv, work) -> Cint
...
"""
function gsl_multilarge_nlinear_eval_fvv(h, x, v, f, swts, fdf, yvv, work)
...
"""
    gsl_multilarge_nlinear_test(xtol, gtol, ftol, info, w) -> Cint
...
"""
function gsl_multilarge_nlinear_test(xtol, gtol, ftol, info, w)
...
"""
    gsl_multilarge_nlinear_df(h, fdtype, x, wts, fdf, f, J, work) -> Cint
...
"""
function gsl_multilarge_nlinear_df(h, fdtype, x, wts, fdf, f, J, work)
...
"""
    gsl_multilarge_nlinear_fdfvv(h, x, v, f, J, swts, fdf, fvv, work) -> Cint
...
"""
function gsl_multilarge_nlinear_fdfvv(h, x, v, f, J, swts, fdf, fvv, work)
