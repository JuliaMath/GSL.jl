...
"""
function gsl_schur_gen_eigvals(A, B, wr1, wr2, wi, scale1, scale2)
...
"""
function gsl_schur_solve_equation(ca, A, z, d1, d2, b, x, s, xnorm, smin)
...
"""
function gsl_schur_solve_equation_z(ca, A, z, d1, d2, b, x, s, xnorm, smin)
