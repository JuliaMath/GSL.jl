...
"""
function gsl_stats_ushort_mean(data, stride, n)
...
"""
function gsl_stats_ushort_variance(data, stride, n)
...
"""
function gsl_stats_ushort_sd(data, stride, n)
...
"""
function gsl_stats_ushort_variance_with_fixed_mean(data, stride, n, mean)
...
"""
function gsl_stats_ushort_sd_with_fixed_mean(data, stride, n, mean)
...
"""
function gsl_stats_ushort_tss(data, stride, n)
...
"""
function gsl_stats_ushort_tss_m(data, stride, n, mean)
...
"""
function gsl_stats_ushort_absdev(data, stride, n)
...
"""
function gsl_stats_ushort_skew(data, stride, n)
...
"""
function gsl_stats_ushort_kurtosis(data, stride, n)
...
"""
function gsl_stats_ushort_lag1_autocorrelation(data, stride, n)
...
"""
function gsl_stats_ushort_covariance(data1, stride1, data2, stride2, n)
...
"""
function gsl_stats_ushort_correlation(data1, stride1, data2, stride2, n)
...
"""
function gsl_stats_ushort_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_ushort_variance_m(data, stride, n, mean)
...
"""
function gsl_stats_ushort_sd_m(data, stride, n, mean)
...
"""
function gsl_stats_ushort_absdev_m(data, stride, n, mean)
...
"""
function gsl_stats_ushort_skew_m_sd(data, stride, n, mean, sd)
...
"""
function gsl_stats_ushort_kurtosis_m_sd(data, stride, n, mean, sd)
...
"""
function gsl_stats_ushort_lag1_autocorrelation_m(data, stride, n, mean)
...
"""
function gsl_stats_ushort_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
function gsl_stats_ushort_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_ushort_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_ushort_max(data, stride, n)
...
"""
function gsl_stats_ushort_min(data, stride, n)
...
"""
function gsl_stats_ushort_minmax(min, max, data, stride, n)
...
"""
function gsl_stats_ushort_max_index(data, stride, n)
...
"""
function gsl_stats_ushort_min_index(data, stride, n)
...
"""
function gsl_stats_ushort_minmax_index(min_index, max_index, data, stride, n)
...
"""
function gsl_stats_ushort_select(data, stride, n, k)
...
"""
function gsl_stats_ushort_median_from_sorted_data(sorted_data, stride, n)
...
"""
function gsl_stats_ushort_median(sorted_data, stride, n)
...
"""
function gsl_stats_ushort_quantile_from_sorted_data(sorted_data, stride, n, f)
...
"""
function gsl_stats_ushort_trmean_from_sorted_data(trim, sorted_data, stride, n)
...
"""
function gsl_stats_ushort_gastwirth_from_sorted_data(sorted_data, stride, n)
...
"""
function gsl_stats_ushort_mad0(data, stride, n, work)
...
"""
function gsl_stats_ushort_mad(data, stride, n, work)
...
"""
function gsl_stats_ushort_Sn0_from_sorted_data(sorted_data, stride, n, work)
...
"""
function gsl_stats_ushort_Sn_from_sorted_data(sorted_data, stride, n, work)
...
"""
function gsl_stats_ushort_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
"""
function gsl_stats_ushort_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
