...
#XXX Unknown input type w::Ptr{gsl_sum_levin_utrunc_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_sum_levin_utrunc_accel (array::Ptr{Cdouble}, array_size::Csize_t, w::Ptr{Void}, sum_accel::Ptr{Cdouble}, abserr_trunc::Ptr{Cdouble})
    ccall( (:gsl_sum_levin_utrunc_accel, "libgsl"), Cint, (Ptr{Cdouble},
        Csize_t, Ptr{Void}, Ptr{Cdouble}, Ptr{Cdouble}), array, array_size, w,
        sum_accel, abserr_trunc )
end
