...
"""
function gsl_matrix_float_alloc_from_block(b, offset, n1, n2, d2)
...
@doc md"""
    gsl_matrix_float_alloc_from_matrix(m, k1, k2, n1, n2) -> Ptr{gsl_matrix_float}
...
"""
function gsl_matrix_float_alloc_from_matrix(m, k1, k2, n1, n2)
...
"""
function gsl_matrix_float_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_float_view_vector_with_tda(v, n1, n2, tda)
...
@doc md"""
    gsl_matrix_float_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_float_const_view
...
"""
function gsl_matrix_float_const_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_float_const_subrow(m, i, offset, n)
...
@doc md"""
    gsl_matrix_float_const_subcolumn(m, j, offset, n) -> _gsl_vector_float_const_view
...
"""
function gsl_matrix_float_const_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_float_const_view_array_with_tda(base, n1, n2, tda)
...
@doc md"""
    gsl_matrix_float_const_view_vector(v, n1, n2) -> _gsl_matrix_float_const_view

C signature:
`_gsl_matrix_float_const_view gsl_matrix_float_const_view_vector (const gsl_vector_float * v, const size_t n1, const size_t n2)`
"""
function gsl_matrix_float_const_view_vector(v, n1, n2)
...
@doc md"""
    gsl_matrix_float_const_view_vector_with_tda(v, n1, n2, tda) -> _gsl_matrix_float_const_view
...
"""
function gsl_matrix_float_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_float_transpose_tricpy(uplo_src, copy_diag, dest, src)
