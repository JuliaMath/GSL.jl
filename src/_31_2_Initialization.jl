...
# member is selected.
# 
#   Returns: Ref{gsl_wavelet}
function wavelet_alloc(T::Ref{gsl_wavelet_type}, k::Integer)
    output_ptr = ccall( (:gsl_wavelet_alloc, libgsl), Ref{gsl_wavelet},
