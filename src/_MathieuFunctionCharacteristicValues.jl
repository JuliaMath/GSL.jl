...
# 
#   Returns: Cint
function gsl_sf_mathieu_a_array (order_min::Cint, order_max::Cint, q::Cdouble, work::Ptr{gsl_sf_mathieu_workspace}, result_array::Cdouble)
    ccall( (:gsl_sf_mathieu_a_array, "libgsl"), Cint, (Cint, Cint, Cdouble,
        Ptr{gsl_sf_mathieu_workspace}, Cdouble), order_min, order_max, q, work,
        result_array )
end
...
# 
#   Returns: Cint
function gsl_sf_mathieu_b_array (order_min::Cint, order_max::Cint, q::Cdouble, work::Ptr{gsl_sf_mathieu_workspace}, result_array::Cdouble)
