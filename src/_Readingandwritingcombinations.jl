...
function gsl_combination_fwrite (stream::Ptr{Void}, c::Ptr{gsl_combination})
    ccall( (:gsl_combination_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_combination_fread (stream::Ptr{Void}, c::Ptr{gsl_combination})
    ccall( (:gsl_combination_fread, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_combination}), stream, c )
end
...
# 
#   Returns: Cint
function gsl_combination_fprintf (stream::Ptr{Void}, c::Ptr{gsl_combination}, format::Ptr{Cchar})
    ccall( (:gsl_combination_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_combination_fscanf (stream::Ptr{Void}, c::Ptr{gsl_combination})
    ccall( (:gsl_combination_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_combination}), stream, c )
end
