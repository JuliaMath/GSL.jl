...
# 
#   Returns: Cint
function gsl_sf_poch_e(a::Cdouble, x::Cdouble)
...
# 
#   Returns: Cint
function gsl_sf_lnpoch_e(a::Cdouble, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cint
function gsl_sf_lnpoch_sgn_e(a::Cdouble, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cint
function gsl_sf_pochrel_e(a::Cdouble, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
