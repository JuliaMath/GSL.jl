...
# 
#   Returns: Cint
function gsl_sf_bessel_j2_e(x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cdouble
function gsl_sf_bessel_jl{gsl_int<:Integer}(l::gsl_int, x::Cdouble)
...
# 
#   Returns: Cint
function gsl_sf_bessel_jl_e{gsl_int<:Integer}(l::gsl_int, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cint
function gsl_sf_bessel_jl_array{gsl_int<:Integer}(lmax::gsl_int, x::Cdouble)
...
# 
#   Returns: Cint
function gsl_sf_bessel_jl_steed_array{gsl_int<:Integer}(lmax::gsl_int, x::Cdouble)
