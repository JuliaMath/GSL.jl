...
"""
function gsl_vector_ushort_alloc_from_block(b, offset, n, stride)
...
@doc md"""
    gsl_vector_ushort_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_ushort}
...
"""
function gsl_vector_ushort_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_ushort_const_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_ushort_const_subvector_with_stride(v, i, stride, n)
