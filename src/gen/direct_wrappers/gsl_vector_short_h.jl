...
"""
function gsl_vector_short_alloc_from_block(b, offset, n, stride)
...
@doc md"""
    gsl_vector_short_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_short}
...
"""
function gsl_vector_short_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_short_const_subvector_with_stride(v, i, stride, n)
