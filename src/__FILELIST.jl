...
struct enumgsl_integration_qawo_enum; end
struct gsl_bspline_deriv_workspace; end
struct gsl_bspline_workspace; end
struct gsl_comparison_fn_t; end
struct gsl_complex_packed_ptr; end
struct gsl_dht; end
struct gsl_integration_cquad_workspace; end
struct gsl_integration_glfixed_table; end
struct gsl_integration_qawo_table; end
struct gsl_integration_qaws_table; end
struct gsl_integration_workspace; end
struct gsl_interp; end
struct gsl_interp_accel; end
struct gsl_interp_type; end
struct gsl_min_fminimizer; end
struct gsl_min_fminimizer_type; end
const gsl_mode_t = Cint
struct gsl_monte_miser_params; end
struct gsl_monte_miser_state; end
struct gsl_monte_plain_state; end
struct gsl_monte_vegas_params; end
struct gsl_monte_vegas_state; end
struct gsl_multifit_fdfsolver; end
struct gsl_multifit_fdfsolver_type; end
struct gsl_multifit_fsolver; end
struct gsl_multifit_fsolver_type; end
struct gsl_multifit_linear_workspace; end
struct gsl_multimin_fdfminimizer; end
struct gsl_multimin_fdfminimizer_type; end
struct gsl_multimin_fminimizer; end
struct gsl_multimin_fminimizer_type; end
struct gsl_multiroot_fdfsolver; end
struct gsl_multiroot_fdfsolver_type; end
struct gsl_multiroot_fsolver; end
struct gsl_multiroot_fsolver_type; end
struct gsl_ntuple_select_fn; end
struct gsl_ntuple_value_fn; end
struct gsl_odeiv2_control; end
struct gsl_odeiv2_control_type; end
struct gsl_odeiv2_driver; end
struct gsl_odeiv2_evolve; end
struct gsl_odeiv2_step; end
struct gsl_odeiv2_step_type; end
struct gsl_poly_complex_workspace; end
struct gsl_qrng; end
struct gsl_qrng_type; end
struct gsl_ran_discrete_t; end
struct gsl_rng; end
struct gsl_rng_type; end
struct gsl_root_fdfsolver; end
struct gsl_root_fdfsolver_type; end
struct gsl_root_fsolver; end
struct gsl_root_fsolver_type; end
struct gsl_sf_mathieu_workspace; end
struct gsl_siman_copy_ruct_t; end
struct gsl_spline; end
struct gsl_sum_levin_u_workspace; end
struct gsl_sum_levin_utrunc_workspace; end
struct gsl_wavelet; end
struct gsl_wavelet_direction; end
struct gsl_wavelet_type; end
struct gsl_wavelet_workspace; end
...
include("36_4_Providing_a_function_to_minimize.jl")
...
include("7_5_2_Irregular_Cylindrical_Bessel_Functions.jl")
include("../src/_7_5_12_Irregular_Modified_Bessel_FunctionsFractional_Order.jl")
include("7_5_4_Irregular_Modified_Cylindrical_Bessel_Functions.jl")
include("7_5_8_Irregular_Modified_Spherical_Bessel_Functions.jl")
include("7_5_6_Irregular_Spherical_Bessel_Functions.jl")
...
include("7_5_1_Regular_Cylindrical_Bessel_Functions.jl")
include("../src/_7_5_11_Regular_Modified_Bessel_FunctionsFractional_Order.jl")
include("7_5_3_Regular_Modified_Cylindrical_Bessel_Functions.jl")
include("7_5_7_Regular_Modified_Spherical_Bessel_Functions.jl")
include("7_5_5_Regular_Spherical_Bessel_Functions.jl")
include("../src/_7_16_2_Relative_Exponential_Functions.jl")
include("41_1_Representation_of_floating_point_numbers.jl")
