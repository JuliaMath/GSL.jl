...
"""
function gsl_multifit_gradient(J, f, g)
...
"""
function gsl_multifit_covar(J, epsrel, covar)
...
"""
function gsl_multifit_covar_QRPT(r, perm, epsrel, covar)
...
"""
function gsl_multifit_fsolver_alloc(T, n, p)
...
"""
function gsl_multifit_fsolver_free(s)
...
"""
function gsl_multifit_fsolver_set(s, f, x)
...
"""
function gsl_multifit_fsolver_iterate(s)
...
"""
function gsl_multifit_fsolver_driver(s, maxiter, epsabs, epsrel)
...
"""
function gsl_multifit_fsolver_name(s)
...
"""
function gsl_multifit_fsolver_position(s)
...
"""
function gsl_multifit_fdfsolver_alloc(T, n, p)
...
"""
function gsl_multifit_fdfsolver_set(s, fdf, x)
...
"""
function gsl_multifit_fdfsolver_wset(s, f, x, wts)
...
"""
function gsl_multifit_fdfsolver_iterate(s)
...
"""
function gsl_multifit_fdfsolver_driver(s, maxiter, xtol, gtol, ftol, info)
...
"""
function gsl_multifit_fdfsolver_jac(s, J)
...
"""
function gsl_multifit_fdfsolver_free(s)
...
"""
function gsl_multifit_fdfsolver_name(s)
...
"""
function gsl_multifit_fdfsolver_position(s)
...
"""
function gsl_multifit_fdfsolver_residual(s)
...
"""
function gsl_multifit_fdfsolver_niter(s)
...
"""
function gsl_multifit_eval_wf(fdf, x, wts, y)
...
"""
function gsl_multifit_eval_wdf(fdf, x, wts, dy)
...
"""
function gsl_multifit_fdfsolver_test(s, xtol, gtol, ftol, info)
...
"""
function gsl_multifit_test_delta(dx, x, epsabs, epsrel)
...
"""
function gsl_multifit_test_gradient(g, epsabs)
...
"""
function gsl_multifit_fdfsolver_dif_df(x, wts, fdf, f, J)
...
"""
function gsl_multifit_fdfsolver_dif_fdf(x, fdf, f, J)
...
"""
function gsl_multifit_fdfridge_alloc(T, n, p)
...
"""
function gsl_multifit_fdfridge_free(work)
...
"""
function gsl_multifit_fdfridge_name(w)
...
"""
function gsl_multifit_fdfridge_position(w)
...
"""
function gsl_multifit_fdfridge_residual(w)
...
"""
function gsl_multifit_fdfridge_niter(w)
...
"""
function gsl_multifit_fdfridge_set(w, f, x, lambda)
...
"""
function gsl_multifit_fdfridge_wset(w, f, x, lambda, wts)
...
"""
function gsl_multifit_fdfridge_set2(w, f, x, lambda)
...
"""
function gsl_multifit_fdfridge_wset2(w, f, x, lambda, wts)
...
"""
function gsl_multifit_fdfridge_set3(w, f, x, L)
...
"""
function gsl_multifit_fdfridge_wset3(w, f, x, L, wts)
...
"""
function gsl_multifit_fdfridge_iterate(w)
...
"""
function gsl_multifit_fdfridge_driver(w, maxiter, xtol, gtol, ftol, info)
