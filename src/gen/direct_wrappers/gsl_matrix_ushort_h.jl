...
"""
function gsl_matrix_ushort_alloc_from_block(b, offset, n1, n2, d2)
...
@doc md"""
    gsl_matrix_ushort_alloc_from_matrix(m, k1, k2, n1, n2) -> Ptr{gsl_matrix_ushort}
...
"""
function gsl_matrix_ushort_alloc_from_matrix(m, k1, k2, n1, n2)
...
"""
function gsl_matrix_ushort_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_ushort_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_ushort_view_array_with_tda(base, n1, n2, tda)
...
"""
function gsl_matrix_ushort_view_vector_with_tda(v, n1, n2, tda)
...
@doc md"""
    gsl_matrix_ushort_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_ushort_const_view
...
"""
function gsl_matrix_ushort_const_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_ushort_const_subrow(m, i, offset, n)
...
@doc md"""
    gsl_matrix_ushort_const_subcolumn(m, j, offset, n) -> _gsl_vector_ushort_const_view
...
"""
function gsl_matrix_ushort_const_subcolumn(m, j, offset, n)
...
@doc md"""
    gsl_matrix_ushort_const_view_array(base, n1, n2) -> _gsl_matrix_ushort_const_view
...
"""
function gsl_matrix_ushort_const_view_array(base, n1, n2)
    ccall((:gsl_matrix_ushort_const_view_array, libgsl), _gsl_matrix_ushort_const_view, (Ref{Cushort}, Csize_t, Csize_t), base, n1, n2)
end

@doc md"""
    gsl_matrix_ushort_const_view_array_with_tda(base, n1, n2, tda) -> _gsl_matrix_ushort_const_view
...
"""
function gsl_matrix_ushort_const_view_array_with_tda(base, n1, n2, tda)
...
@doc md"""
    gsl_matrix_ushort_const_view_vector(v, n1, n2) -> _gsl_matrix_ushort_const_view
...
"""
function gsl_matrix_ushort_const_view_vector(v, n1, n2)
...
@doc md"""
    gsl_matrix_ushort_const_view_vector_with_tda(v, n1, n2, tda) -> _gsl_matrix_ushort_const_view
...
"""
function gsl_matrix_ushort_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_ushort_transpose_tricpy(uplo_src, copy_diag, dest, src)
