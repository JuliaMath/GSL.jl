...
### function gsl_permutation_fwrite (stream::Ptr{FILE}, p::Ptr{gsl_permutation})
###     ccall( (:gsl_permutation_fwrite, "libgsl"), Cint, (Ptr{FILE},
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type p::Ptr{gsl_permutation}
### function gsl_permutation_fread (stream::Ptr{FILE}, p::Ptr{gsl_permutation})
###     ccall( (:gsl_permutation_fread, "libgsl"), Cint, (Ptr{FILE},
###         Ptr{gsl_permutation}), stream, p )
### end
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type p::Ptr{gsl_permutation}
### function gsl_permutation_fprintf (stream::Ptr{FILE}, p::Ptr{gsl_permutation}, format::Ptr{Cchar})
###     ccall( (:gsl_permutation_fprintf, "libgsl"), Cint, (Ptr{FILE},
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type p::Ptr{gsl_permutation}
### function gsl_permutation_fscanf (stream::Ptr{FILE}, p::Ptr{gsl_permutation})
###     ccall( (:gsl_permutation_fscanf, "libgsl"), Cint, (Ptr{FILE},
###         Ptr{gsl_permutation}), stream, p )
### end