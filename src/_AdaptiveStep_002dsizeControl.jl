...
# 
#   Returns: Cint
function gsl_odeiv2_control_init (c::Ptr{gsl_odeiv2_control}, eps_abs::Cdouble, eps_rel::Cdouble, a_y::Cdouble, a_dydt::Cdouble)
    ccall( (:gsl_odeiv2_control_init, "libgsl"), Cint,
...
# 
#   Returns: Cint
function gsl_odeiv2_control_hadjust (c::Ptr{gsl_odeiv2_control}, s::Ptr{gsl_odeiv2_step}, y::Cdouble)
    ccall( (:gsl_odeiv2_control_hadjust, "libgsl"), Cint,
...
function gsl_odeiv2_control_name (c::Ptr{gsl_odeiv2_control})
    ccall( (:gsl_odeiv2_control_name, "libgsl"), Ptr{Cchar},
        (Ptr{gsl_odeiv2_control}, ), c )
end
...
# 
#   Returns: Cint
function gsl_odeiv2_control_errlevel (c::Ptr{gsl_odeiv2_control}, y::Cdouble, dydt::Cdouble, h::Cdouble, ind::Csize_t, errlev::Ptr{Cdouble})
    ccall( (:gsl_odeiv2_control_errlevel, "libgsl"), Cint,
...
# 
#   Returns: Cint
function gsl_odeiv2_control_set_driver (c::Ptr{gsl_odeiv2_control}, d::Ptr{gsl_odeiv2_driver})
    ccall( (:gsl_odeiv2_control_set_driver, "libgsl"), Cint,
