...
#XXX Unknown input type w::Ptr{gsl_eigen_herm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_herm (A::Ptr{Void}, eval::Ptr{gsl_vector}, w::Ptr{Void})
    ccall( (:gsl_eigen_herm, "libgsl"), Cint, (Ptr{Void}, Ptr{gsl_vector},
        Ptr{Void}), A, eval, w )
end
...
#XXX Unknown input type w::Ptr{gsl_eigen_hermv_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_hermv (A::Ptr{Void}, eval::Ptr{gsl_vector}, evec::Ptr{Void}, w::Ptr{Void})
    ccall( (:gsl_eigen_hermv, "libgsl"), Cint, (Ptr{Void}, Ptr{gsl_vector},
        Ptr{Void}, Ptr{Void}), A, eval, evec, w )
end
