...
"""
function gsl_vector_float_alloc(n)
...
"""
function gsl_vector_float_calloc(n)
...
"""
function gsl_vector_float_alloc_from_block(b, offset, n, stride)
...
"""
function gsl_vector_float_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_float_free(v)
...
"""
function gsl_vector_float_view_array(v, n)
...
"""
function gsl_vector_float_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_float_const_view_array(v, n)
...
"""
function gsl_vector_float_const_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_float_subvector(v, i, n)
...
"""
function gsl_vector_float_subvector_with_stride(v, i, stride, n)
...
"""
function gsl_vector_float_const_subvector(v, i, n)
...
"""
function gsl_vector_float_const_subvector_with_stride(v, i, stride, n)
...
"""
function gsl_vector_float_set_zero(v)
...
"""
function gsl_vector_float_set_all(v, x)
...
"""
function gsl_vector_float_set_basis(v, i)
...
"""
function gsl_vector_float_fread(stream, v)
...
"""
function gsl_vector_float_fwrite(stream, v)
...
"""
function gsl_vector_float_fscanf(stream, v)
...
"""
function gsl_vector_float_fprintf(stream, v, format)
...
"""
function gsl_vector_float_memcpy(dest, src)
...
"""
function gsl_vector_float_reverse(v)
...
"""
function gsl_vector_float_swap(v, w)
...
"""
function gsl_vector_float_swap_elements(v, i, j)
...
"""
function gsl_vector_float_max(v)
...
"""
function gsl_vector_float_min(v)
...
"""
function gsl_vector_float_minmax(v, min_out, max_out)
...
"""
function gsl_vector_float_max_index(v)
...
"""
function gsl_vector_float_min_index(v)
...
"""
function gsl_vector_float_minmax_index(v, imin, imax)
...
"""
function gsl_vector_float_add(a, b)
...
"""
function gsl_vector_float_sub(a, b)
...
"""
function gsl_vector_float_mul(a, b)
...
"""
function gsl_vector_float_div(a, b)
...
"""
function gsl_vector_float_scale(a, x)
...
"""
function gsl_vector_float_add_constant(a, x)
...
"""
function gsl_vector_float_equal(u, v)
...
"""
function gsl_vector_float_isnull(v)
...
"""
function gsl_vector_float_ispos(v)
...
"""
function gsl_vector_float_isneg(v)
...
"""
function gsl_vector_float_isnonneg(v)
...
"""
function gsl_vector_float_get(v, i)
...
"""
function gsl_vector_float_set(v, i, x)
...
"""
function gsl_vector_float_ptr(v, i)
...
"""
function gsl_vector_float_const_ptr(v, i)
