...
# 
#   Returns: Ref{Cchar}
function rng_name(r::Ref{gsl_rng})
...
# 
#   Returns: Culong
function rng_max(r::Ref{gsl_rng})
    ccall( (:gsl_rng_max, libgsl), Culong, (Ref{gsl_rng}, ), r )
end
...
# 
#   Returns: Culong
function rng_min(r::Ref{gsl_rng})
    ccall( (:gsl_rng_min, libgsl), Culong, (Ref{gsl_rng}, ), r )
end
...
function rng_state(r::Ref{gsl_rng})
    output_ptr = ccall( (:gsl_rng_state, libgsl), Ref{Void},
        (Ref{gsl_rng}, ), r )
    output_ptr==C_NULL ? throw(GSL_ERROR(8)) : output_ptr
end
...
# 
#   Returns: Csize_t
function rng_size(r::Ref{gsl_rng})
    ccall( (:gsl_rng_size, libgsl), Csize_t, (Ref{gsl_rng}, ), r )
end
