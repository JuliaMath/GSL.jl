...
function gsl_odeiv2_control_init (c::Ptr{Void}, eps_abs::Cdouble, eps_rel::Cdouble, a_y::Cdouble, a_dydt::Cdouble)
    ccall( (:gsl_odeiv2_control_init, "libgsl"), Cint, (Ptr{Void}, Cdouble,
        Cdouble, Cdouble, Cdouble), c, eps_abs, eps_rel, a_y, a_dydt )
end
...
function gsl_odeiv2_control_hadjust (c::Ptr{Void}, s::Ptr{Void}, y::Cdouble)
    ccall( (:gsl_odeiv2_control_hadjust, "libgsl"), Cint, (Ptr{Void},
        Ptr{Void}, Cdouble), c, s, y )
end
...
function gsl_odeiv2_control_name (c::Ptr{Void})
    ccall( (:gsl_odeiv2_control_name, "libgsl"), Ptr{Cchar}, (Ptr{Void}, ),
        c )
end
...
#XXX Unknown input type c::Ptr{gsl_odeiv2_control}
#XXX Coerced type for c::Ptr{Void}
function gsl_odeiv2_control_errlevel (c::Ptr{Void}, y::Cdouble, dydt::Cdouble, h::Cdouble, ind::Csize_t, errlev::Ptr{Cdouble})
    ccall( (:gsl_odeiv2_control_errlevel, "libgsl"), Cint, (Ptr{Void},
        Cdouble, Cdouble, Cdouble, Csize_t, Ptr{Cdouble}), c, y, dydt, h, ind,
        errlev )
end
...
function gsl_odeiv2_control_set_driver (c::Ptr{Void}, d::Ptr{Void})
    ccall( (:gsl_odeiv2_control_set_driver, "libgsl"), Cint, (Ptr{Void},
        Ptr{Void}), c, d )
end
