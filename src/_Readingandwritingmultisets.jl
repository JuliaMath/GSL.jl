...
function gsl_multiset_fwrite (stream::Ptr{Void}, c::Ptr{gsl_multiset})
    ccall( (:gsl_multiset_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_multiset_fread (stream::Ptr{Void}, c::Ptr{gsl_multiset})
    ccall( (:gsl_multiset_fread, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_multiset}), stream, c )
end
...
# 
#   Returns: Cint
function gsl_multiset_fprintf (stream::Ptr{Void}, c::Ptr{gsl_multiset}, format::Ptr{Cchar})
    ccall( (:gsl_multiset_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_multiset_fscanf (stream::Ptr{Void}, c::Ptr{gsl_multiset})
    ccall( (:gsl_multiset_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_multiset}), stream, c )
end
