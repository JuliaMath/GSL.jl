...
function gsl_permutation_fwrite (stream::Ptr{Void}, p::Ptr{gsl_permutation})
    ccall( (:gsl_permutation_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_permutation_fread (stream::Ptr{Void}, p::Ptr{gsl_permutation})
    ccall( (:gsl_permutation_fread, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}), stream, p )
end
...
# 
#   Returns: Cint
function gsl_permutation_fprintf (stream::Ptr{Void}, p::Ptr{gsl_permutation}, format::Ptr{Cchar})
    ccall( (:gsl_permutation_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_permutation_fscanf (stream::Ptr{Void}, p::Ptr{gsl_permutation})
    ccall( (:gsl_permutation_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_permutation}), stream, p )
end
