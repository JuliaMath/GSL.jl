...
"""
function gsl_matrix_uint_alloc_from_block(b, offset, n1, n2, d2)
...
"""
    gsl_matrix_uint_alloc_from_matrix(m, k1, k2, n1, n2) -> Ptr{gsl_matrix_uint}
...
"""
function gsl_matrix_uint_alloc_from_matrix(m, k1, k2, n1, n2)
...
"""
function gsl_matrix_uint_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_uint_view_vector_with_tda(v, n1, n2, tda)
...
"""
    gsl_matrix_uint_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_uint_const_view
...
"""
function gsl_matrix_uint_const_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_uint_const_subrow(m, i, offset, n)
...
"""
    gsl_matrix_uint_const_subcolumn(m, j, offset, n) -> _gsl_vector_uint_const_view
...
"""
function gsl_matrix_uint_const_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_uint_const_view_array_with_tda(base, n1, n2, tda)
...
"""
function gsl_matrix_uint_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_uint_transpose_tricpy(uplo_src, copy_diag, dest, src)
