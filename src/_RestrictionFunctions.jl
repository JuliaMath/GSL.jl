...
# 
#   Returns: Cint
function gsl_sf_angle_restrict_symm_e (theta::Ptr{Cdouble})
    ccall( (:gsl_sf_angle_restrict_symm_e, "libgsl"), Cint, (Ptr{Cdouble},
        ), theta )
end
...
# 
#   Returns: Cint
function gsl_sf_angle_restrict_pos_e (theta::Ptr{Cdouble})
    ccall( (:gsl_sf_angle_restrict_pos_e, "libgsl"), Cint, (Ptr{Cdouble},
        ), theta )
end