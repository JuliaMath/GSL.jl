...
"""
function gsl_vector_complex_float_alloc_from_block(b, offset, n, stride)
...
@doc md"""
    gsl_vector_complex_float_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_complex_float}
...
"""
function gsl_vector_complex_float_alloc_from_vector(v, offset, n, stride)
...
@doc md"""
    gsl_vector_complex_float_const_view_array(base, n) -> _gsl_vector_complex_float_const_view

C signature:
`_gsl_vector_complex_float_const_view gsl_vector_complex_float_const_view_array (const float *base, size_t n)`
"""
function gsl_vector_complex_float_const_view_array(base, n)
    ccall((:gsl_vector_complex_float_const_view_array, libgsl), _gsl_vector_complex_float_const_view, (Ref{Cfloat}, Csize_t), base, n)
end

@doc md"""
    gsl_vector_complex_float_const_view_array_with_stride(base, stride, n) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_vector_complex_float_const_view_array_with_stride(base, stride, n)
...
@doc md"""
    gsl_vector_complex_float_subvector(base, i, n) -> _gsl_vector_complex_float_view

C signature:
`_gsl_vector_complex_float_view gsl_vector_complex_float_subvector (gsl_vector_complex_float *base, size_t i, size_t n)`
"""
function gsl_vector_complex_float_subvector(base, i, n)
...
@doc md"""
    gsl_vector_complex_float_subvector_with_stride(v, i, stride, n) -> _gsl_vector_complex_float_view
...
"""
function gsl_vector_complex_float_subvector_with_stride(v, i, stride, n)
...
@doc md"""
    gsl_vector_complex_float_const_subvector(base, i, n) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_vector_complex_float_const_subvector(base, i, n)
...
@doc md"""
    gsl_vector_complex_float_const_subvector_with_stride(v, i, stride, n) -> _gsl_vector_complex_float_const_view
...
"""
function gsl_vector_complex_float_const_subvector_with_stride(v, i, stride, n)
