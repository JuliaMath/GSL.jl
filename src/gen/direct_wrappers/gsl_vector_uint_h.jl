...
@doc md"""
    gsl_vector_uint_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_uint}
...
"""
function gsl_vector_uint_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_uint_const_subvector_with_stride(v, i, stride, n)
