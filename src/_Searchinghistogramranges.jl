...
# 
#   Returns: Cint
function gsl_histogram_find (h::Ptr{gsl_histogram}, x::Cdouble, i::Ptr{Csize_t})
    ccall( (:gsl_histogram_find, "libgsl"), Cint, (Ptr{gsl_histogram},
        Cdouble, Ptr{Csize_t}), h, x, i )
end
