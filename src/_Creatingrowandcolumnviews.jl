...
### function gsl_matrix_row (m::Ptr{gsl_matrix}, i::Csize_t)
...
### function gsl_matrix_const_row (m::Ptr{gsl_matrix}, i::Csize_t)
###     ccall( (:gsl_matrix_const_row, "libgsl"), gsl_vector_const_view,
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_view
### function gsl_matrix_column (m::Ptr{gsl_matrix}, j::Csize_t)
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_const_view
### function gsl_matrix_const_column (m::Ptr{gsl_matrix}, j::Csize_t)
###     ccall( (:gsl_matrix_const_column, "libgsl"), gsl_vector_const_view,
###         (Ptr{gsl_matrix}, Csize_t), m, j )
### end
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_view
### function gsl_matrix_subrow (m::Ptr{gsl_matrix}, i::Csize_t, offset::Csize_t, n::Csize_t)
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_const_view
### function gsl_matrix_const_subrow (m::Ptr{gsl_matrix}, i::Csize_t, offset::Csize_t, n::Csize_t)
###     ccall( (:gsl_matrix_const_subrow, "libgsl"), gsl_vector_const_view,
###         (Ptr{gsl_matrix}, Csize_t, Csize_t, Csize_t), m, i, offset, n )
### end
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_view
### function gsl_matrix_subcolumn (m::Ptr{gsl_matrix}, j::Csize_t, offset::Csize_t, n::Csize_t)
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_const_view
### function gsl_matrix_const_subcolumn (m::Ptr{gsl_matrix}, j::Csize_t, offset::Csize_t, n::Csize_t)
###     ccall( (:gsl_matrix_const_subcolumn, "libgsl"), gsl_vector_const_view,
###         (Ptr{gsl_matrix}, Csize_t, Csize_t, Csize_t), m, j, offset, n )
### end
...
###     ccall( (:gsl_matrix_const_diagonal, "libgsl"), gsl_vector_const_view,
###         (Ptr{gsl_matrix}, ), m )
### end
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_view
### function gsl_matrix_subdiagonal (m::Ptr{gsl_matrix}, k::Csize_t)
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_const_view
### function gsl_matrix_const_subdiagonal (m::Ptr{gsl_matrix}, k::Csize_t)
###     ccall( (:gsl_matrix_const_subdiagonal, "libgsl"),
###         gsl_vector_const_view, (Ptr{gsl_matrix}, Csize_t), m, k )
### end
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_view
### function gsl_matrix_superdiagonal (m::Ptr{gsl_matrix}, k::Csize_t)
...
### #XXX Unknown input type m::Ptr{gsl_matrix}
### #XXX Unknown output type gsl_vector_const_view
### function gsl_matrix_const_superdiagonal (m::Ptr{gsl_matrix}, k::Csize_t)
###     ccall( (:gsl_matrix_const_superdiagonal, "libgsl"),
###         gsl_vector_const_view, (Ptr{gsl_matrix}, Csize_t), m, k )
### end