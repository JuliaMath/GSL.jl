...
function gsl_integration_qags (f::Ptr{gsl_function}, a::Cdouble, b::Cdouble, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qags, "libgsl"), Cint, (Ptr{gsl_function},
        Cdouble, Cdouble, Cdouble, Cdouble, Csize_t, Ptr{Void}, Ptr{Cdouble},
        Ptr{Cdouble}), f, a, b, epsabs, epsrel, limit, workspace, result,
        abserr )
end
