...
"""
function gsl_stats_int_correlation(data1, stride1, data2, stride2, n)
    ccall((:gsl_stats_int_correlation, libgsl), Cdouble, (Ref{Cint}, Csize_t, Ref{Cint}, Csize_t, Csize_t), data1, stride1, data2, stride2, n)
end

"""
    gsl_stats_int_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_int_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_int_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
    gsl_stats_int_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_int_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
    gsl_stats_int_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_int_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
    gsl_stats_int_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble

C signature:
`double gsl_stats_int_Qn_from_sorted_data (const int sorted_data[], const size_t stride, const size_t n, int work[], int work_int[])`
"""
function gsl_stats_int_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
