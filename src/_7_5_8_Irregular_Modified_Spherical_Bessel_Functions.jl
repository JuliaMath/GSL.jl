...
# 
#   Returns: Cint
function gsl_sf_bessel_k2_scaled_e(x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cdouble
function gsl_sf_bessel_kl_scaled{gsl_int<:Integer}(l::gsl_int, x::Cdouble)
...
# 
#   Returns: Cint
function gsl_sf_bessel_kl_scaled_e{gsl_int<:Integer}(l::gsl_int, x::Cdouble)
    result = convert(Ptr{gsl_sf_result}, Array(gsl_sf_result, 1))
...
# 
#   Returns: Cint
function gsl_sf_bessel_kl_scaled_array{gsl_int<:Integer}(lmax::gsl_int, x::Cdouble)
