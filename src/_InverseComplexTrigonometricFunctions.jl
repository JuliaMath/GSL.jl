...
function gsl_complex_arcsin_real (z::Cdouble)
    ccall( (:gsl_complex_arcsin_real, "libgsl"), gsl_complex, (Cdouble, ),
        z )
end
...
function gsl_complex_arccos_real (z::Cdouble)
    ccall( (:gsl_complex_arccos_real, "libgsl"), gsl_complex, (Cdouble, ),
        z )
end
...
function gsl_complex_arcsec_real (z::Cdouble)
    ccall( (:gsl_complex_arcsec_real, "libgsl"), gsl_complex, (Cdouble, ),
        z )
end
...
function gsl_complex_arccsc_real (z::Cdouble)
    ccall( (:gsl_complex_arccsc_real, "libgsl"), gsl_complex, (Cdouble, ),
        z )
end
