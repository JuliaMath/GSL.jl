...
function gsl_integration_qagi (f::Ptr{gsl_function}, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qagi, "libgsl"), Cint, (Ptr{gsl_function},
        Cdouble, Cdouble, Csize_t, Ptr{Void}, Ptr{Cdouble}, Ptr{Cdouble}), f,
...
#XXX Unknown input type workspace::Ptr{gsl_integration_workspace}
#XXX Coerced type for workspace::Ptr{Void}
function gsl_integration_qagiu (f::Ptr{gsl_function}, a::Cdouble, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qagiu, "libgsl"), Cint, (Ptr{gsl_function},
        Cdouble, Cdouble, Cdouble, Csize_t, Ptr{Void}, Ptr{Cdouble},
        Ptr{Cdouble}), f, a, epsabs, epsrel, limit, workspace, result, abserr )
end
...
#XXX Unknown input type workspace::Ptr{gsl_integration_workspace}
#XXX Coerced type for workspace::Ptr{Void}
function gsl_integration_qagil (f::Ptr{gsl_function}, b::Cdouble, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qagil, "libgsl"), Cint, (Ptr{gsl_function},
        Cdouble, Cdouble, Cdouble, Csize_t, Ptr{Void}, Ptr{Cdouble},
        Ptr{Cdouble}), f, b, epsabs, epsrel, limit, workspace, result, abserr )
end
