...
###################################
export vector_get, vector_set, vector_ptr, vector_const_ptr
...
# 
#   Returns: Cdouble
function vector_get(v::Ptr{gsl_vector}, i::Integer)
...
# 
#   Returns: Void
function vector_set(v::Ptr{gsl_vector}, i::Integer, x::Real)
...
# 
#   Returns: Ptr{Cdouble}
function vector_ptr(v::Ptr{gsl_vector}, i::Integer)
...
# 
#   Returns: Ptr{Cdouble}
function vector_const_ptr(v::Ptr{gsl_vector}, i::Integer)
