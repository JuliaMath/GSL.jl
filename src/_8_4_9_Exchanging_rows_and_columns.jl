...
#####################################
export matrix_swap_rows, matrix_swap_columns, matrix_swap_rowcol,
       matrix_transpose_memcpy, matrix_transpose


# This function exchanges the i-th and j-th rows of the matrix m in-place.
# 
#   Returns: Cint
function matrix_swap_rows(i::Integer, j::Integer)
...
# 
#   Returns: Cint
function matrix_swap_columns(i::Integer, j::Integer)
    m = convert(Ptr{gsl_matrix}, Array(gsl_matrix, 1))
...
# 
#   Returns: Cint
function matrix_swap_rowcol(i::Integer, j::Integer)
    m = convert(Ptr{gsl_matrix}, Array(gsl_matrix, 1))
...
# 
#   Returns: Cint
function matrix_transpose_memcpy(src::Ptr{gsl_matrix})
