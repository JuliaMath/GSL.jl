...
###########################
export linalg_bidiag_decomp, linalg_bidiag_unpack, linalg_bidiag_unpack2,
       linalg_bidiag_unpack_B
...
function linalg_bidiag_decomp()
    ...
    errno = ccall( (:gsl_linalg_bidiag_decomp, :libgsl), Cint,
...
# 
#   Returns: Cint
function linalg_bidiag_unpack(A::Ptr{gsl_matrix}, tau_U::Ptr{gsl_vector}, tau_V::Ptr{gsl_vector})
    ...
    errno = ccall( (:gsl_linalg_bidiag_unpack, :libgsl), Cint,
...
# 
#   Returns: Cint
function linalg_bidiag_unpack2()
    A = convert(Ptr{gsl_matrix}, Array(gsl_matrix, 1))
    tau_U = convert(Ptr{gsl_vector}, Array(gsl_vector, 1))
    tau_V = convert(Ptr{gsl_vector}, Array(gsl_vector, 1))
    V = convert(Ptr{gsl_matrix}, Array(gsl_matrix, 1))
    errno = ccall( (:gsl_linalg_bidiag_unpack2, :libgsl), Cint,
...
# 
#   Returns: Cint
function linalg_bidiag_unpack_B(A::Ptr{gsl_matrix})
    diag = convert(Ptr{gsl_vector}, Array(gsl_vector, 1))
    superdiag = convert(Ptr{gsl_vector}, Array(gsl_vector, 1))
    errno = ccall( (:gsl_linalg_bidiag_unpack_B, :libgsl), Cint,
