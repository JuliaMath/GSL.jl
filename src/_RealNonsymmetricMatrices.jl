...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymm_params (compute_t::Cint, balance::Cint, w::Ptr{Void})
...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymm (A::Ptr{gsl_matrix}, eval::Ptr{Void}, w::Ptr{Void})
    ccall( (:gsl_eigen_nonsymm, "libgsl"), Cint, (Ptr{gsl_matrix},
        Ptr{Void}, Ptr{Void}), A, eval, w )
end
...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymm_Z (A::Ptr{gsl_matrix}, eval::Ptr{Void}, Z::Ptr{gsl_matrix}, w::Ptr{Void})
    ccall( (:gsl_eigen_nonsymm_Z, "libgsl"), Cint, (Ptr{gsl_matrix},
        Ptr{Void}, Ptr{gsl_matrix}, Ptr{Void}), A, eval, Z, w )
end
...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymm_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymmv_params (balance::Cint, w::Ptr{Void})
...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymmv_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymmv (A::Ptr{gsl_matrix}, eval::Ptr{Void}, evec::Ptr{Void}, w::Ptr{Void})
    ccall( (:gsl_eigen_nonsymmv, "libgsl"), Cint, (Ptr{gsl_matrix},
        Ptr{Void}, Ptr{Void}, Ptr{Void}), A, eval, evec, w )
end
...
#XXX Unknown input type w::Ptr{gsl_eigen_nonsymmv_workspace}
#XXX Coerced type for w::Ptr{Void}
function gsl_eigen_nonsymmv_Z (A::Ptr{gsl_matrix}, eval::Ptr{Void}, evec::Ptr{Void}, Z::Ptr{gsl_matrix}, w::Ptr{Void})
    ccall( (:gsl_eigen_nonsymmv_Z, "libgsl"), Cint, (Ptr{gsl_matrix},
        Ptr{Void}, Ptr{Void}, Ptr{gsl_matrix}, Ptr{Void}), A, eval, evec, Z, w
        )
end
