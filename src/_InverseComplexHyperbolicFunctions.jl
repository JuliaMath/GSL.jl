...
function gsl_complex_arcsinh (z::gsl_complex)
    ccall( (:gsl_complex_arcsinh, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
...
function gsl_complex_arccosh (z::gsl_complex)
    ccall( (:gsl_complex_arccosh, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
...
function gsl_complex_arctanh (z::gsl_complex)
    ccall( (:gsl_complex_arctanh, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
...
function gsl_complex_arcsech (z::gsl_complex)
    ccall( (:gsl_complex_arcsech, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
...
function gsl_complex_arccsch (z::gsl_complex)
    ccall( (:gsl_complex_arccsch, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
...
function gsl_complex_arccoth (z::gsl_complex)
    ccall( (:gsl_complex_arccoth, "libgsl"), gsl_complex, (gsl_complex, ),
        z )
end
