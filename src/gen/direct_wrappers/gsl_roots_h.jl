...
> solver of type T. For example, the following code creates an instance
> of a bisection solver:
>
...
> use the function f and the initial search interval \[x\_lower,
> x\_upper\].
...
> GSL\_SUCCESS if the following condition is achieved,
>
> and returns GSL\_CONTINUE otherwise.
