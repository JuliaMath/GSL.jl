...
"""
    gsl_vector_long_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_long}
...
"""
function gsl_vector_long_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_long_const_subvector_with_stride(v, i, stride, n)
