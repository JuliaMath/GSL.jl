...
### function gsl_histogram_fwrite (stream::Ptr{FILE}, h::Ptr{gsl_histogram})
###     ccall( (:gsl_histogram_fwrite, "libgsl"), Cint, (Ptr{FILE},
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type h::Ptr{gsl_histogram}
### function gsl_histogram_fread (stream::Ptr{FILE}, h::Ptr{gsl_histogram})
###     ccall( (:gsl_histogram_fread, "libgsl"), Cint, (Ptr{FILE},
###         Ptr{gsl_histogram}), stream, h )
### end
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type h::Ptr{gsl_histogram}
### function gsl_histogram_fprintf (stream::Ptr{FILE}, h::Ptr{gsl_histogram}, range_format::Ptr{Cchar}, bin_format::Ptr{Cchar})
###     ccall( (:gsl_histogram_fprintf, "libgsl"), Cint, (Ptr{FILE},
...
### #XXX Unknown input type stream::Ptr{FILE}
### #XXX Unknown input type h::Ptr{gsl_histogram}
### function gsl_histogram_fscanf (stream::Ptr{FILE}, h::Ptr{gsl_histogram})
###     ccall( (:gsl_histogram_fscanf, "libgsl"), Cint, (Ptr{FILE},
###         Ptr{gsl_histogram}), stream, h )
### end