...
# 
#   Returns: Void
function gsl_vector_minmax (v::Ptr{gsl_vector}, min_out::Ptr{Cdouble}, max_out::Ptr{Cdouble})
...
# 
#   Returns: Void
function gsl_vector_minmax_index (v::Ptr{gsl_vector}, imin::Ptr{Csize_t}, imax::Ptr{Csize_t})
