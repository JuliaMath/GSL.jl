...
# 
#   Returns: Cint
function gsl_fit_linear{tB<:Real ,tA<:Real}(x::Ptr{tA}, xstride::Integer, y::Ptr{tB}, ystride::Integer, n::Integer)
...
# 
#   Returns: Cint
function gsl_fit_wlinear{tB<:Real ,tC<:Real ,tA<:Real}(x::Ptr{tA}, xstride::Integer, w::Ptr{tB}, wstride::Integer, y::Ptr{tC}, ystride::Integer, n::Integer)
    c0 = convert(Ptr{Cdouble}, Array(Cdouble, 1))
    c1 = convert(Ptr{Cdouble}, Array(Cdouble, 1))
    cov00 = convert(Ptr{Cdouble}, Array(Cdouble, 1))
    cov01 = convert(Ptr{Cdouble}, Array(Cdouble, 1))
...
# 
#   Returns: Cint
function gsl_fit_linear_est(x::Real, c0::Real, c1::Real, cov00::Real, cov01::Real, cov11::Real)
...
#@vectorize_6arg Number gsl_fit_linear_est
