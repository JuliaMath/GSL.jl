...
"""
function gsl_stats_uint_covariance(data1, stride1, data2, stride2, n)
    ccall((:gsl_stats_uint_covariance, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Ref{Cuint}, Csize_t, Csize_t), data1, stride1, data2, stride2, n)
end

@doc md"""
    gsl_stats_uint_correlation(data1, stride1, data2, stride2, n) -> Cdouble
...
"""
function gsl_stats_uint_correlation(data1, stride1, data2, stride2, n)
...
@doc md"""
    gsl_stats_uint_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_uint_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_uint_skew_m_sd(data, stride, n, mean, sd)
    ccall((:gsl_stats_uint_skew_m_sd, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Csize_t, Cdouble, Cdouble), data, stride, n, mean, sd)
end

@doc md"""
    gsl_stats_uint_kurtosis_m_sd(data, stride, n, mean, sd) -> Cdouble
...
"""
function gsl_stats_uint_kurtosis_m_sd(data, stride, n, mean, sd)
    ccall((:gsl_stats_uint_kurtosis_m_sd, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Csize_t, Cdouble, Cdouble), data, stride, n, mean, sd)
end

@doc md"""
    gsl_stats_uint_lag1_autocorrelation_m(data, stride, n, mean) -> Cdouble
...
"""
function gsl_stats_uint_lag1_autocorrelation_m(data, stride, n, mean)
    ccall((:gsl_stats_uint_lag1_autocorrelation_m, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Csize_t, Cdouble), data, stride, n, mean)
end

@doc md"""
    gsl_stats_uint_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2) -> Cdouble
...
"""
function gsl_stats_uint_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
@doc md"""
    gsl_stats_uint_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_uint_pvariance(data1, stride1, n1, data2, stride2, n2)
...
@doc md"""
    gsl_stats_uint_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_uint_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_uint_minmax_index(min_index, max_index, data, stride, n)
...
"""
function gsl_stats_uint_quantile_from_sorted_data(sorted_data, stride, n, f)
    ccall((:gsl_stats_uint_quantile_from_sorted_data, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Csize_t, Cdouble), sorted_data, stride, n, f)
end

@doc md"""
    gsl_stats_uint_trmean_from_sorted_data(trim, sorted_data, stride, n) -> Cdouble
...
"""
function gsl_stats_uint_Sn0_from_sorted_data(sorted_data, stride, n, work)
    ccall((:gsl_stats_uint_Sn0_from_sorted_data, libgsl), Cuint, (Ref{Cuint}, Csize_t, Csize_t, Ref{Cuint}), sorted_data, stride, n, work)
end

@doc md"""
    gsl_stats_uint_Sn_from_sorted_data(sorted_data, stride, n, work) -> Cdouble
...
"""
function gsl_stats_uint_Sn_from_sorted_data(sorted_data, stride, n, work)
    ccall((:gsl_stats_uint_Sn_from_sorted_data, libgsl), Cdouble, (Ref{Cuint}, Csize_t, Csize_t, Ref{Cuint}), sorted_data, stride, n, work)
end

@doc md"""
    gsl_stats_uint_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cuint
...
"""
function gsl_stats_uint_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
@doc md"""
    gsl_stats_uint_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble
...
"""
function gsl_stats_uint_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
