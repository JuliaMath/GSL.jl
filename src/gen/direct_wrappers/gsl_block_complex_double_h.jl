...
"""
function gsl_block_complex_alloc(n)
...
"""
function gsl_block_complex_calloc(n)
...
"""
function gsl_block_complex_free(b)
...
"""
function gsl_block_complex_fread(stream, b)
...
"""
function gsl_block_complex_fwrite(stream, b)
...
"""
function gsl_block_complex_fscanf(stream, b)
...
"""
function gsl_block_complex_fprintf(stream, b, format)
...
"""
function gsl_block_complex_raw_fread(stream, b, n, stride)
...
"""
function gsl_block_complex_raw_fwrite(stream, b, n, stride)
...
"""
function gsl_block_complex_raw_fscanf(stream, b, n, stride)
...
"""
function gsl_block_complex_raw_fprintf(stream, b, n, stride, format)
...
"""
function gsl_block_complex_size(b)
...
"""
function gsl_block_complex_data(b)
