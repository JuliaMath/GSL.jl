...
function gsl_matrix_fwrite (stream::Ptr{Void}, m::Ptr{gsl_matrix})
    ccall( (:gsl_matrix_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_matrix_fread (stream::Ptr{Void}, m::Ptr{gsl_matrix})
    ccall( (:gsl_matrix_fread, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_matrix}), stream, m )
end
...
# 
#   Returns: Cint
function gsl_matrix_fprintf (stream::Ptr{Void}, m::Ptr{gsl_matrix}, format::Ptr{Cchar})
    ccall( (:gsl_matrix_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_matrix_fscanf (stream::Ptr{Void}, m::Ptr{gsl_matrix})
    ccall( (:gsl_matrix_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_matrix}), stream, m )
end
