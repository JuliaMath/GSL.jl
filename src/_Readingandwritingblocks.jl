...
function gsl_block_fwrite (stream::Ptr{Void}, b::Ptr{gsl_block})
    ccall( (:gsl_block_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_block_fread (stream::Ptr{Void}, b::Ptr{gsl_block})
    ccall( (:gsl_block_fread, "libgsl"), Cint, (Ptr{Void}, Ptr{gsl_block}),
        stream, b )
end
...
# 
#   Returns: Cint
function gsl_block_fprintf (stream::Ptr{Void}, b::Ptr{gsl_block}, format::Ptr{Cchar})
    ccall( (:gsl_block_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_block_fscanf (stream::Ptr{Void}, b::Ptr{gsl_block})
    ccall( (:gsl_block_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_block}), stream, b )
end
