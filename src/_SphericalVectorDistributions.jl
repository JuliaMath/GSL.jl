...
function gsl_ran_dir_2d (r::Ptr{Void}, x::Ptr{Cdouble}, y::Ptr{Cdouble})
...
#XXX Unknown input type r::Ptr{gsl_rng}
#XXX Coerced type for r::Ptr{Void}
function gsl_ran_dir_2d_trig_method (r::Ptr{Void}, x::Ptr{Cdouble}, y::Ptr{Cdouble})
...
#XXX Unknown input type r::Ptr{gsl_rng}
#XXX Coerced type for r::Ptr{Void}
function gsl_ran_dir_3d (r::Ptr{Void}, x::Ptr{Cdouble}, y::Ptr{Cdouble}, z::Ptr{Cdouble})
...
#XXX Unknown input type r::Ptr{gsl_rng}
#XXX Coerced type for r::Ptr{Void}
function gsl_ran_dir_nd (r::Ptr{Void}, n::Csize_t, x::Ptr{Cdouble})
