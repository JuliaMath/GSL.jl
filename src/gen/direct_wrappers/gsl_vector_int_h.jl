...
"""
    gsl_vector_int_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_int}

C signature:
`gsl_vector_int *gsl_vector_int_alloc_from_vector (gsl_vector_int * v, const size_t offset, const size_t n, const size_t stride)`
"""
function gsl_vector_int_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_int_const_subvector_with_stride(v, i, stride, n)
