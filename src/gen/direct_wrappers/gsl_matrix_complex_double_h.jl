...
"""
function gsl_matrix_complex_alloc_from_block(b, offset, n1, n2, d2)
...
"""
    gsl_matrix_complex_alloc_from_matrix(b, k1, k2, n1, n2) -> Ptr{gsl_matrix_complex}
...
"""
function gsl_matrix_complex_alloc_from_matrix(b, k1, k2, n1, n2)
...
"""
function gsl_matrix_complex_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_complex_subrow(m, i, offset, n)
...
"""
    gsl_matrix_complex_subcolumn(m, j, offset, n) -> _gsl_vector_complex_view
...
"""
function gsl_matrix_complex_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_complex_view_array_with_tda(base, n1, n2, tda)
...
"""
function gsl_matrix_complex_view_vector_with_tda(v, n1, n2, tda)
...
"""
    gsl_matrix_complex_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_complex_const_view
...
"""
function gsl_matrix_complex_const_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_complex_const_subrow(m, i, offset, n)
...
"""
    gsl_matrix_complex_const_subcolumn(m, j, offset, n) -> _gsl_vector_complex_const_view
...
"""
function gsl_matrix_complex_const_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_complex_const_view_array_with_tda(base, n1, n2, tda)
...
"""
    gsl_matrix_complex_const_view_vector(v, n1, n2) -> _gsl_matrix_complex_const_view
...
"""
function gsl_matrix_complex_const_view_vector(v, n1, n2)
...
"""
    gsl_matrix_complex_const_view_vector_with_tda(v, n1, n2, tda) -> _gsl_matrix_complex_const_view
...
"""
function gsl_matrix_complex_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_complex_tricpy(uplo_src, copy_diag, dest, src)
...
"""
function gsl_matrix_complex_transpose_tricpy(uplo_src, copy_diag, dest, src)
