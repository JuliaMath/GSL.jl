...
"""
function gsl_vector_uchar_alloc_from_block(b, offset, n, stride)
...
@doc md"""
    gsl_vector_uchar_alloc_from_vector(v, offset, n, stride) -> Ptr{gsl_vector_uchar}
...
"""
function gsl_vector_uchar_alloc_from_vector(v, offset, n, stride)
...
"""
function gsl_vector_uchar_const_view_array_with_stride(base, stride, n)
...
"""
function gsl_vector_uchar_const_subvector_with_stride(v, i, stride, n)
