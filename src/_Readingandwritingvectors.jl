...
function gsl_vector_fwrite (stream::Ptr{Void}, v::Ptr{gsl_vector})
    ccall( (:gsl_vector_fwrite, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_vector_fread (stream::Ptr{Void}, v::Ptr{gsl_vector})
    ccall( (:gsl_vector_fread, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_vector}), stream, v )
end
...
# 
#   Returns: Cint
function gsl_vector_fprintf (stream::Ptr{Void}, v::Ptr{gsl_vector}, format::Ptr{Cchar})
    ccall( (:gsl_vector_fprintf, "libgsl"), Cint, (Ptr{Void},
...
# 
#   Returns: Cint
function gsl_vector_fscanf (stream::Ptr{Void}, v::Ptr{gsl_vector})
    ccall( (:gsl_vector_fscanf, "libgsl"), Cint, (Ptr{Void},
        Ptr{gsl_vector}), stream, v )
end
