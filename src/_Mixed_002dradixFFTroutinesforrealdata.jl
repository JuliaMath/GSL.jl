...
###############################################
export gsl_fft_real_wavetable_alloc, gsl_fft_halfcomplex_wavetable_alloc,
       gsl_fft_real_wavetable_free, gsl_fft_halfcomplex_wavetable_free,
       gsl_fft_real_workspace_alloc, gsl_fft_real_workspace_free,
       gsl_fft_real_transform, gsl_fft_halfcomplex_transform,
...
function gsl_fft_real_transform (data::Cdouble)
    ccall( (:gsl_fft_real_transform, "libgsl"), Cint, (Cdouble, ), data )
end
...
function gsl_fft_halfcomplex_transform (data::Cdouble)
    ccall( (:gsl_fft_halfcomplex_transform, "libgsl"), Cint, (Cdouble, ),
        data )
end
...
function gsl_fft_real_unpack (real_coefficient::Cdouble)
    ccall( (:gsl_fft_real_unpack, "libgsl"), Cint, (Cdouble, ),
        real_coefficient )
end
...
function gsl_fft_halfcomplex_unpack (halfcomplex_coefficient::Cdouble)
    ccall( (:gsl_fft_halfcomplex_unpack, "libgsl"), Cint, (Cdouble, ),
