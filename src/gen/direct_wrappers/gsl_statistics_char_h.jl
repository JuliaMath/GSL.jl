...
"""
function gsl_stats_char_covariance(data1, stride1, data2, stride2, n)
    ccall((:gsl_stats_char_covariance, libgsl), Cdouble, (Ref{Cchar}, Csize_t, Ref{Cchar}, Csize_t, Csize_t), data1, stride1, data2, stride2, n)
end

@doc md"""
    gsl_stats_char_correlation(data1, stride1, data2, stride2, n) -> Cdouble
...
"""
function gsl_stats_char_correlation(data1, stride1, data2, stride2, n)
...
@doc md"""
    gsl_stats_char_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_char_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_char_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
@doc md"""
    gsl_stats_char_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_char_pvariance(data1, stride1, n1, data2, stride2, n2)
...
@doc md"""
    gsl_stats_char_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_char_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_char_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
@doc md"""
    gsl_stats_char_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble
...
"""
function gsl_stats_char_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
