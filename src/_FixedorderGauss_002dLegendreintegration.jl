...
#XXX Unknown input type t::Ptr{gsl_integration_glfixed_table}
#XXX Coerced type for t::Ptr{Void}
function gsl_integration_glfixed_point (a::Cdouble, b::Cdouble, i::Csize_t, xi::Ptr{Cdouble}, wi::Ptr{Cdouble}, t::Ptr{Void})
    ccall( (:gsl_integration_glfixed_point, "libgsl"), Cint, (Cdouble,
        Cdouble, Csize_t, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Void}), a, b, i, xi,
        wi, t )
end
