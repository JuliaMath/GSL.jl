...
function gsl_integration_qaws_table_set (t::Ptr{Void}, alpha::Cdouble, beta::Cdouble, mu::Cint, nu::Cint)
    ccall( (:gsl_integration_qaws_table_set, "libgsl"), Cint, (Ptr{Void},
        Cdouble, Cdouble, Cint, Cint), t, alpha, beta, mu, nu )
end
...
function gsl_integration_qaws (f::Ptr{gsl_function}, a::Cdouble, b::Cdouble, t::Ptr{Void}, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qaws, "libgsl"), Cint, (Ptr{gsl_function},
        Cdouble, Cdouble, Ptr{Void}, Cdouble, Cdouble, Csize_t, Ptr{Void},
