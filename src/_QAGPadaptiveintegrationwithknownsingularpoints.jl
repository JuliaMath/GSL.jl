...
function gsl_integration_qagp (f::Ptr{gsl_function}, pts::Ptr{Cdouble}, npts::Csize_t, epsabs::Cdouble, epsrel::Cdouble, limit::Csize_t, workspace::Ptr{Void}, result::Ptr{Cdouble}, abserr::Ptr{Cdouble})
    ccall( (:gsl_integration_qagp, "libgsl"), Cint, (Ptr{gsl_function},
        Ptr{Cdouble}, Csize_t, Cdouble, Cdouble, Csize_t, Ptr{Void},
        Ptr{Cdouble}, Ptr{Cdouble}), f, pts, npts, epsabs, epsrel, limit,
