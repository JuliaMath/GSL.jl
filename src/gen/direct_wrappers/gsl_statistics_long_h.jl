...
"""
function gsl_stats_long_covariance(data1, stride1, data2, stride2, n)
    ccall((:gsl_stats_long_covariance, libgsl), Cdouble, (Ref{Clong}, Csize_t, Ref{Clong}, Csize_t, Csize_t), data1, stride1, data2, stride2, n)
end

"""
    gsl_stats_long_correlation(data1, stride1, data2, stride2, n) -> Cdouble
...
"""
function gsl_stats_long_correlation(data1, stride1, data2, stride2, n)
...
"""
    gsl_stats_long_spearman(data1, stride1, data2, stride2, n, work) -> Cdouble
...
"""
function gsl_stats_long_spearman(data1, stride1, data2, stride2, n, work)
...
"""
function gsl_stats_long_covariance_m(data1, stride1, data2, stride2, n, mean1, mean2)
...
"""
    gsl_stats_long_pvariance(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_long_pvariance(data1, stride1, n1, data2, stride2, n2)
...
"""
    gsl_stats_long_ttest(data1, stride1, n1, data2, stride2, n2) -> Cdouble
...
"""
function gsl_stats_long_ttest(data1, stride1, n1, data2, stride2, n2)
...
"""
function gsl_stats_long_Qn0_from_sorted_data(sorted_data, stride, n, work, work_int)
...
"""
    gsl_stats_long_Qn_from_sorted_data(sorted_data, stride, n, work, work_int) -> Cdouble
...
"""
function gsl_stats_long_Qn_from_sorted_data(sorted_data, stride, n, work, work_int)
