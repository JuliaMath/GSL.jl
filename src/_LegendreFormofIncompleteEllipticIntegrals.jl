...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_F_e (phi::Cdouble, k::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_F_e, "libgsl"), Cint, (Cdouble, Cdouble, Void,
        Ptr{gsl_sf_result}), phi, k, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_E_e (phi::Cdouble, k::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_E_e, "libgsl"), Cint, (Cdouble, Cdouble, Void,
        Ptr{gsl_sf_result}), phi, k, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_P_e (phi::Cdouble, k::Cdouble, n::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_P_e, "libgsl"), Cint, (Cdouble, Cdouble,
        Cdouble, Void, Ptr{gsl_sf_result}), phi, k, n, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_D_e (phi::Cdouble, k::Cdouble, n::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
