...
"""
function gsl_matrix_char_alloc_from_block(b, offset, n1, n2, d2)
...
@doc md"""
    gsl_matrix_char_alloc_from_matrix(m, k1, k2, n1, n2) -> Ptr{gsl_matrix_char}
...
"""
function gsl_matrix_char_alloc_from_matrix(m, k1, k2, n1, n2)
...
"""
function gsl_matrix_char_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_char_view_vector_with_tda(v, n1, n2, tda)
...
@doc md"""
    gsl_matrix_char_const_submatrix(m, i, j, n1, n2) -> _gsl_matrix_char_const_view
...
"""
function gsl_matrix_char_const_submatrix(m, i, j, n1, n2)
...
"""
function gsl_matrix_char_const_subrow(m, i, offset, n)
...
@doc md"""
    gsl_matrix_char_const_subcolumn(m, j, offset, n) -> _gsl_vector_char_const_view
...
"""
function gsl_matrix_char_const_subcolumn(m, j, offset, n)
...
"""
function gsl_matrix_char_const_view_array_with_tda(base, n1, n2, tda)
...
"""
function gsl_matrix_char_const_view_vector_with_tda(v, n1, n2, tda)
...
"""
function gsl_matrix_char_transpose_tricpy(uplo_src, copy_diag, dest, src)
