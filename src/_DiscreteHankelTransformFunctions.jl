...
function gsl_dht_init (t::Ptr{Void}, nu::Cdouble, xmax::Cdouble)
    ccall( (:gsl_dht_init, "libgsl"), Cint, (Ptr{Void}, Cdouble, Cdouble),
        t, nu, xmax )
end
...
function gsl_dht_new (size::Csize_t, nu::Cdouble, xmax::Cdouble)
    ccall( (:gsl_dht_new, "libgsl"), Ptr{Void}, (Csize_t, Cdouble,
...
#XXX Unknown input type t::Ptr{gsl_dht}
#XXX Coerced type for t::Ptr{Void}
function gsl_dht_apply (t::Ptr{Void}, f_in::Ptr{Cdouble}, f_out::Ptr{Cdouble})
    ccall( (:gsl_dht_apply, "libgsl"), Cint, (Ptr{Void}, Ptr{Cdouble},
...
#XXX Unknown input type t::Ptr{gsl_dht}
#XXX Coerced type for t::Ptr{Void}
function gsl_dht_x_sample (t::Ptr{Void}, n::Cint)
...
#XXX Unknown input type t::Ptr{gsl_dht}
#XXX Coerced type for t::Ptr{Void}
function gsl_dht_k_sample (t::Ptr{Void}, n::Cint)
