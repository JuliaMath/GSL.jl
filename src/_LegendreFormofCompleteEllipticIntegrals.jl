...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_Kcomp_e (k::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_Kcomp_e, "libgsl"), Cint, (Cdouble, Void,
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_Ecomp_e (k::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_Ecomp_e, "libgsl"), Cint, (Cdouble, Void,
        Ptr{gsl_sf_result}), k, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_ellint_Pcomp_e (k::Cdouble, n::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_ellint_Pcomp_e, "libgsl"), Cint, (Cdouble, Cdouble,
        Void, Ptr{gsl_sf_result}), k, n, mode, result )
end
