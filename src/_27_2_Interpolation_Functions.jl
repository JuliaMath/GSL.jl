...
function gsl_interp_alloc(T::Ptr{gsl_interp_type}, size::Integer)
...
# 
#   Returns: Cint
function gsl_interp_init(interp::Ptr{gsl_interp}, xa::Real)
    gsl_errno = ccall( (:gsl_interp_init, :libgsl), Cint, (Ptr{gsl_interp},
        Cdouble), interp, xa )
