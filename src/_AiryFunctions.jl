...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_airy_Ai_e (x::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_airy_Ai_e, "libgsl"), Cint, (Cdouble, Void,
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_airy_Bi_e (x::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_airy_Bi_e, "libgsl"), Cint, (Cdouble, Void,
        Ptr{gsl_sf_result}), x, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_airy_Ai_scaled_e (x::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_airy_Ai_scaled_e, "libgsl"), Cint, (Cdouble, Void,
        Ptr{gsl_sf_result}), x, mode, result )
end
...
#XXX Unknown input type mode::gsl_mode_t
#XXX Coerced type for mode::Void
function gsl_sf_airy_Bi_scaled_e (x::Cdouble, mode::Void, result::Ptr{gsl_sf_result})
    ccall( (:gsl_sf_airy_Bi_scaled_e, "libgsl"), Cint, (Cdouble, Void,
        Ptr{gsl_sf_result}), x, mode, result )
end
